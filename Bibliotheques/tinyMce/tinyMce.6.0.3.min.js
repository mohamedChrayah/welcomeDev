...
! function() {
    ...
    const qr = (e, t = !0) => ((e, t) => {
        ...
        As = (e, t, n) => {
            ...
            const s = () => { Ns(e, "DOMContentLoaded", s), Ns(e, "load", s), n.domLoaded || (n.domLoaded = !0, t(r)), e = null };
    ...
    class Os {
        ...
        bind(e, t, n, o) {
            ...
            let s, a, i, l, d, c, u;
            const m = window,
                f = e => { r.executeHandlers(Rs(e || m.event), s) };
            ...
            }), a = r.events[s][l], a ? "ready" === l && r.domLoaded ? n(Rs({ type: l })) : a.push({ func: n, scope: o }) : (r.events[s][l] = a = [{ func: n, scope: o }], a.fakeName = d, a.capture = u, a.nativeHandler = c, "ready" === l ? As(e, c, r) : Es(e, d || l, c, u)));
            return e = a = null, n
        }
        unbind(e, t, n) {
            let o, r, s, a, i;
            ...
            if (l) {
                ...
                } else fe(i, ((t, n) => { Ns(e, t.fakeName || n, t.nativeHandler, t.capture) })), i = {};
                for (a in i)
    ...
    const Ts = Bt.each,
        ...
        Us = (e, t = {}) => {
            ...
            const a = Yo.forElement(mn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
                ...
                R = (e, n, o) => {
                    const r = (e, t) => m(e) ? e : w(e) ? we(Is, t) ? e + "" : e + "px" : ge(e, r),
                        s = (e, t, n) => {
                            const o = Fs(t);
                ...
                L = function(e, t, n) {
                    const o = null != n ? n : this,
                        r = m(e) ? g(e) : e;
                    if (!r) return !1;
                    if (p(r) && (r.length || 0 === r.length)) { const e = []; return Ts(r, ((n, r) => { n && e.push(t.call(o, m(n) ? g(n) : n, r)) })), e }
                    return t.call(o, r)
                },
                ...
                Q = {
                    ...
                    replace: q,
                    rename: (e, t) => { let n; return e.nodeName !== t.toUpperCase() && (n = F(t), Ts(v(e), (t => { k(n, t.nodeName, b(e, t.nodeName)) })), q(n, e, !0)), n || e },
                    ...
                    createRng: K,
                    nodeIndex: Ms,
                    split: (e, t, n) => { let o, r, s, a = K(); if (e && t) return a.setStart(e.parentNode, Ms(e)), a.setEnd(t.parentNode, Ms(t)), o = a.extractContents(), a = K(), a.setStart(t.parentNode, Ms(t) + 1), a.setEnd(e.parentNode, Ms(e) + 1), r = a.extractContents(), s = e.parentNode, s.insertBefore(Gr(Q, o), e), n ? s.insertBefore(n, e) : s.insertBefore(t, e), s.insertBefore(Gr(Q, r), e), z(e), n || t },
                    bind: G,
                    unbind: Y,
    ...
    const Vs = e => { let t = e; return { get: () => t, set: e => { t = e } } },
        Hs = {},
        $s = Vs("en"),
        qs = () => xe(Hs, $s.get()),
        Ws = {
            ...
            add: (e, t) => {
                let n = Hs[e];
                n || (Hs[e] = n = {}), fe(t, ((e, t) => { n[t.toLowerCase()] = e }))
            },
            translate: e => {
                const t = qs().getOr({}),
            ...
            isRtl: () => qs().bind((e => xe(e, "_dir"))).exists((e => "rtl" === e)),
            hasCode: e => we(Hs, e)
        },
        Ks = () => {
            const e = [],
            ...
            return {
                ...
                requireLangPack: (e, t) => {!1 !== Ks.languageLoad && (s(e) ? a(e, t) : i(e, "loaded").then((() => a(e, t)))) },
    ...
    const Gs = () => {
        ...
        oa = (e, t) => {
            ...
            return i.bind((t => l(t, `${ta()}`).bind((n => l(t, `${ea()}`).map((t => { const o = ra(e, n); return { uid: n, name: t, elements: o } }))))))
        },
    ...
    const ia = e => {
        ...
        ma = (e, t) => {
            ...
            return { backwards: (e, t, r, s) => { const a = ua(e, s, n); return o(e, t, (() => a.prev().map((e => ({ container: e, offset: e.length })))), r).getOrNull() }, forwards: (e, t, r, s) => { const a = ua(e, s, n); return o(e, t, (() => a.next().map((e => ({ container: e, offset: 0 })))), r).getOrNull() } }
        },
        fa = Math.round,
        ...
        Ia = e => {
            const t = e.startContainer,
                n = e.startOffset;
            if (Pa(e.toString()) && Aa(t.parentNode) && No(t)) { const e = t.data; if (Pa(e[n - 1]) || Pa(e[n + 1])) return !0 }
            return !1
        },
        ...
        Ua = e => {
            ...
            return t = n.length > 0 ? ga(n[0]) : ga(e.getBoundingClientRect()), !Ma(e) && Ta(e) && Fa(t) ? (e => {
                ...
                const t = e.startContainer,
                    ...
                    o = e.startOffset,
                    r = e.endOffset;
                if (t === n && No(n) && 0 === o && 1 === r) { const t = e.cloneRange(); return t.setEndAfter(n), Ua(t) }
                return null
            })(e) : t
        },
        ...
        ja = (e, t, n) => {
            const o = () => (n || (n = (e => {
                const t = [],
                    ...
                    o = (e, o) => {
                        ...
                        if (o < e.data.length) { if (ka(e.data[o])) return t; if (ka(e.data[o - 1]) && (r.setStart(e, o), r.setEnd(e, o + 1), !Ia(r))) return n(za(Ua(r), !1)), t }
            ...
            return { container: N(e), offset: N(t), toRange: () => { const n = La(e.ownerDocument); return n.setStart(e, t), n.setEnd(e, t), n }, getClientRects: o, isVisible: () => o().length > 0, isAtStart: () => (Oa(e), 0 === t), isAtEnd: () => Oa(e) ? t >= e.data.length : t >= e.childNodes.length, isEqual: n => n && e === n.container() && t === n.offset(), getNode: n => Da(e, n ? t - 1 : t) }
        };
    ...
    const Va = (e, t) => { No(t) && 0 === t.data.length && e.remove(t) },
        Ha = (e, t, n) => {
            Bo(n) ? ((e, t, n) => {
            ...
            })(e, t, n) : ((e, t, n) => { t.insertNode(n), Va(e, n.previousSibling), Va(e, n.nextSibling) })(e, t, n)
        },
        $a = No,
        qa = ko,
        Wa = Us.nodeIndex,
        ...
        Qa = (e, t) => {
            ...
            return n = t.container(), o = t.offset(), $a(n) ? r = ((e, t) => {
                for (;
                    (e = e.previousSibling) && $a(e);) t += e.data.length;
                return t
            })(n, o) : (s = n.childNodes, o >= s.length ? (r = "after", o = s.length - 1) : r = "before", n = s[o]), i.push(Xa(n)), a = ((e, t, n) => { const o = []; for (t = t.parentNode; t !== e; t = t.parentNode) o.push(t); return o })(e, n), a = Re(a, T(ko)), i = i.concat(Ne(a, (e => Xa(e)))), i.reverse().join("/") + "," + r
        },
        Ja = (e, t) => {
            let n;
            if (!t) return null;
            ...
            const s = Oe(r, ((e, t) => { const n = /([\w\-\(\)]+)\[([0-9]+)\]/.exec(t); return n ? ("text()" === n[1] && (n[1] = "#text"), ((e, t, n) => { let o = Ga(e); return o = Re(o, ((e, t) => !$a(e) || !$a(o[t - 1]))), o = Re(o, Co([t])), o[n] })(e, n[1], parseInt(n[2], 10))) : null }), e);
            return s ? $a(s) ? ((e, t) => {
                let n, o = e,
                    r = 0;
                for (; $a(o);) {
                    if (n = o.data.length, t >= r && t <= r + n) { e = o, t -= r; break }
                    if (!$a(o.nextSibling)) { e = o, t = n; break }
                    r += n, o = o.nextSibling
                }
        ...
        di = e => {
            const t = t => t(e),
                n = N(e),
                o = () => r,
                r = { tag: !0, inner: e, fold: (t, n) => n(e), isValue: P, isError: L, map: t => ui.value(t(e)), mapError: o, bind: t, exists: t, forall: t, getOr: n, or: o, getOrThunk: n, orThunk: o, getOrDie: n, each: t => { t(e) }, toOptional: () => M.some(e) };
            return r
        },
        ci = e => {
            const t = () => n,
                n = { tag: !1, inner: e, fold: (t, n) => t(e), isValue: L, isError: P, map: t, mapError: t => ui.error(t(e)), bind: t, exists: L, forall: P, getOr: R, or: R, getOrThunk: B, orThunk: B, getOrDie: (o = String(e), () => { throw new Error(o) }), each: S, toOptional: M.none };
            var o;
            return n
        },
    ...
    const fi = e => "inline-command" === e.type || "inline-format" === e.type,
        ...
        pi = e => {
            const t = t => ui.error({ message: t, pattern: e }),
                n = (n, o, r) => {
                    if (void 0 !== e.format) {
                        let r;
                        if (p(e.format)) {
        ...
        cd = (e, t) => ja.isTextPosition(t) ? ((e, t) => sd(e) && t.container() === e ? ((e, t) => {
            const n = id(e.data.substr(0, t.offset())),
                o = id(e.data.substr(t.offset()));
            return (n.text + o.text).length > 0 ? (ld(e), ja(e, t.offset() - n.count)) : t
        })(e, t) : dd(e, t))(e, t) : ((e, t) => t.container() === e.parentNode ? ((e, t) => {
            const n = t.container(),
                o = ((e, t) => { const n = z(e, t); return -1 === n ? M.none() : M.some(n) })(de(n.childNodes), e).map((e => e < t.offset() ? ja(n, t.offset() - 1) : t)).getOr(t);
            return ud(e), o
        })(e, t) : dd(e, t))(e, t),
        ...
        hd = (e, t, n, o) => {
            ...
            const i = Di(e),
                ...
                d = () => {
                    ...
                    })(t), a && (ud(a), a = null), r.on((e => { l.remove(e.caret), r.clear() })), s && (clearInterval(s), s = void 0)
                };
            return {
                show: (e, c) => {
                    let u;
        ...
        Td = (e, t, n, o, r) => {
            ...
            if (Ad(t)) {
                ...
                for (; e = Od(s.prev.bind(s), r);)
                    if (n(e)) return e
            }
            if (Rd(t)) {
                if (a && n(e = Od(s.next.bind(s), !0))) return e;
                for (; e = Od(s.next.bind(s), r);)
                    if (n(e)) return e
            }
            return null
        },
        ...
        Id = (e, t, n) => {
            ...
            for (; n && n !== t;) {
                let e = n[o];
                if (Sd(e) && (e = e[o]), xd(e) || wd(e)) { if (Md(t, e, n)) return e; break }
                if (Nd(e)) break;
                n = n.parentNode
            }
            return null
        ...
        zd = (e, t, n) => {
            ...
            if (hr(a)) { Ed(a) || (a = a.parentNode); const e = a.getAttribute("data-mce-caret"); if ("before" === e && (o = a.nextSibling, yd(o))) return Fd(o); if ("after" === e && (o = a.previousSibling, yd(o))) return Ud(o) }
            if (!n.collapsed) return n;
            if (No(a)) { if (Sd(a)) { if (1 === e) { if (o = s(a), o) return Fd(o); if (o = r(a), o) return Ud(o) } if (-1 === e) { if (o = r(a), o) return Ud(o); if (o = s(a), o) return Fd(o) } return n } if (kr(a) && i >= a.data.length - 1) return 1 === e && (o = s(a), o) ? Fd(o) : n; if (wr(a) && i <= 1) return -1 === e && (o = r(a), o) ? Ud(o) : n; if (i === a.data.length) return o = s(a), o ? Fd(o) : n; if (0 === i) return o = r(a), o ? Ud(o) : n }
            return n
        },
        ...
        qd = (e, t) => { const n = Dd(e, t); return !(n || !Do(e.getNode())) || n };
    var Wd;
    ! function(e) { e[e.Backwards = -1] = "Backwards", e[e.Forwards = 1] = "Forwards" }(Wd || (Wd = {}));
    const Kd = Mo,
        Gd = No,
        Yd = yo,
        Xd = Do,
        ...
        nc = (e, t, n) => {
            ...
            if (t.isEqual(ja.after(n)) && n.lastChild) { if (a = ja.after(n.lastChild), Ad(e) && Qd(n.lastChild) && Yd(n.lastChild)) return Xd(n.lastChild) ? ja.before(n.lastChild) : a } else a = t;
            const i = a.container();
            let l = a.offset();
            if (Gd(i)) {
                ...
                if (Rd(e) && l < i.childNodes.length && (r = ec(i, l), Qd(r))) return Xd(r) ? ((e, t) => { const n = t.nextSibling; return n && Qd(n) ? Gd(n) ? ja(n, 0) : ja.before(n) : nc(Wd.Forwards, ja.after(t), e) })(n, r) : !Jd(r) && (s = Td(r, e, Zd, r), s) ? Gd(s) ? ja(s, 0) : ja.before(s) : Gd(r) ? ja(r, 0) : ja.after(r);
                o = r || a.getNode()
            }
            if ((Rd(e) && a.isAtEnd() || Ad(e) && a.isAtStart()) && (o = Td(o, e, P, n, !0), Zd(o, n))) return tc(e, o);
            r = Td(o, e, Zd, n);
            const d = Be(K(((e, t) => { const n = []; for (; e && e !== t;) n.push(e), e = e.parentNode; return n })(i, n), Kd));
        ...
        Ec = (e, t) => {
            ((e, t) => {
                const n = e.dom;
                if (t) {
                    if (vc(t)) return ((e, t) => { const n = e.createRng(); return wc(e, !0, t, n) && wc(e, !1, t, n) ? M.some(n) : M.none() })(n, t);
                    ...
                    if ((e => we(e, "id"))(t)) return ((e, t) => {
                        const n = Sc(e, "start", t),
                            o = Sc(e, "end", t);
                        return Lt(n, o.or(n), ((t, n) => { const o = e.createRng(); return o.setStart(yc(e, t.container()), t.offset()), o.setEnd(yc(e, n.container()), n.offset()), o }))
                    })(n, t);
    ...
    const Ac = e => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        lu = (e, t, n, o, r, s) => {
            ...
            return l(n, o, au).bind((e => s ? l(e.container, e.offset + (r ? -1 : 0), iu) : M.some(e))).orThunk((() => a ? M.some({ container: a, offset: r ? 0 : a.length }) : M.none()))
        },
        du = (e, t, n, o, r) => {
        ...
        cu = (e, t, n, o) => {
            ...
            if (r && Xc(i) && i.wrapper && (r = tu(s, r, "ul,ol").reverse()[0] || r), !r)
                for (r = n; r[o] && !s.isBlock(r[o]) && (r = r[o], !qc(r, "br")););
            return r || n
        },
        ...
        mu = (e, t, n, o, r) => {
            ...
            for (;;) {
                ...
                for (let t = s[a]; t; t = t[a]) { const n = No(t) && !uu(e, i, t, a); if (!eu(t) && (!Do(l = t) || !l.getAttribute("data-mce-bogus") || l.nextSibling) && !nu(t, n)) return s }
        ...
        Ru = e => Nu.get(e),
        Au = e => Nu.getOption(e),
        Ou = (e, { uid: t = ia("mce-annotation"), ...n }, o, r) => {
            const s = cn("span", e);
        ...
        Bu = e => {
            ...
            ((e, t) => {
                e.serializer.addTempAttr(na()), e.serializer.addNodeFilter("span", (e => {
                    $(e, (e => {
                        (e => M.from(e.attr(ea())).bind(t.lookup))(e).each((t => {!1 === t.persistent && e.unwrap() }))
                    }))
                }))
            })(e, t);
            const n = ((e, t) => {
            ...
            return {
                    ...
                    t.lookup(n).each((t => {
                        ((e, t, n, o) => {
                            e.undoManager.transact((() => {
                                ...
                                } else Eu(r, !1, (() => { _u(e, (r => { Tu(e, r, t, n.decorate, o) })) }))
                            }))
                        })(e, n, t, o)
                    }))
                },
                ...
                remove: t => {
                    ...
                    oa(e, M.some(t)).each((({ elements: e }) => { $(e, no) })), e.selection.moveToBookmark(n)
                },
                removeAll: t => {
                    const n = e.selection.getBookmark();
                    fe(sa(e, t), ((e, t) => $(e, no))), e.selection.moveToBookmark(n)
                },
                getAll: t => { const n = sa(e, t); return ge(n, (e => H(e, (e => e.dom)))) }
            }
        },
    ...
    const Lu = (e, t, n) => !n.collapsed && V(n.getClientRects(), (n => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t))),
        ...
        Vu = (e, t) => {
            ...
            return t.on("init", (() => {
                z();
                const e = Ys((e => { t.composing || F(e) }), 0);
    ...
    const Ku = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
        ...
        em = (e, t) => {
            const n = e.fold(Xu.before, Zu, Xu.after),
                o = t.fold(Xu.before, Zu, Xu.after);
        ...
        fm = (e, t, n, o) => {
            ...
            if (yo(r) && s > r.childNodes.length - 1 && (l = !1), To(r) && (r = a, s = 0), r === a) {
                if (l && (i = r.childNodes[s > 0 ? s - 1 : 0], i)) { if (vr(i)) return M.none(); if (u[i.nodeName] || lm(i)) return M.none() }
                if (r.hasChildNodes()) {
                    ...
                    if (r.hasChildNodes() && !1 === lm(r)) {
                        i = r;
                        const t = new Xo(r, a);
                        do { if (Mo(i) || vr(i)) { d = !1; break } if (No(i) && i.nodeValue.length > 0) { s = l ? 0 : i.nodeValue.length, r = i, d = !0; break } if (u[i.nodeName.toLowerCase()] && !dm(i)) { s = e.nodeIndex(i), r = i.parentNode, l || s++, d = !0; break } } while (i = l ? t.next() : t.prev())
                    }
                }
            }
            return t && (No(r) && 0 === s && mm(e, c, t, !0, r).each((e => { r = e.container(), s = e.offset(), d = !0 })), yo(r) && (i = r.childNodes[s], i || (i = r.childNodes[s - 1]), !i || !Do(i) || ((e, t) => e.previousSibling && "A" === e.previousSibling.nodeName)(i) || um(e, i, !1) || um(e, i, !0) || mm(e, c, t, !0, i).each((e => { r = e.container(), s = e.offset(), d = !0 })))), l && !t && No(r) && s === r.nodeValue.length && mm(e, c, t, !1, r).each((e => { r = e.container(), s = e.offset(), d = !0 })), d ? M.some(ja(r, s)) : M.none()
        },
        gm = (e, t) => {
            const n = t.collapsed,
                o = t.cloneRange(),
                r = ja.fromRangeStart(t);
            return fm(e, n, !0, o).each((e => { n && ja.isAbove(r, e) || o.setStart(e.container(), e.offset()) })), n || fm(e, n, !1, o).each((e => { o.setEnd(e.container(), e.offset()) })), n && o.collapse(!0), sm(t, o) ? M.none() : M.some(o)
        },
    ...
    const vm = ((e, t) => {
        ...
        ym = () => mn(document),
        Cm = (e, t) => e.view(t).fold(N([]), (t => {
            const n = e.owner(t),
                o = Cm(e, n);
            return [t].concat(o)
        }));
    var xm = Object.freeze({ __proto__: null, view: e => { var t; return (e.dom === document ? M.none() : M.from(null === (t = e.dom.defaultView) || void 0 === t ? void 0 : t.frameElement)).map(mn) }, owner: e => Cn(e) });
    const wm = e => "textarea" === Mt(e),
        km = (e, t) => {
            const n = (e => {
        ...
        Em = (e, t, n, o) => {
            ...
            r.dom.offsetWidth;
            const a = ((e, t) => {
                const n = ((e, t) => { const n = Nn(e); if (0 === n.length || wm(e)) return { element: e, offset: t }; if (t < n.length && !wm(n[t])) return { element: n[t], offset: 0 }; { const o = n[n.length - 1]; return wm(o) ? { element: e, offset: t } : "img" === Mt(o) ? { element: o, offset: 1 } : zt(o) ? { element: o, offset: Ru(o).length } : { element: o, offset: Nn(o).length } } })(e, t),
        ...
        Km = e => {
            const t = (e => e.inline)(e) ? (n = mn(e.getBody()), (e => { const t = e.getSelection(); return (t && 0 !== t.rangeCount ? M.from(t.getRangeAt(0)) : M.none()).map(qm) })(xn(n).dom).filter($m(n))) : M.none();
            var n;
        ...
        Xm = { setEditorTimeout: (e, t, n) => ((e, t) => (w(t) || (t = 0), setTimeout(e, t)))((() => { e.removed || t() }), n), setEditorInterval: (e, t, n) => { const o = ((e, t) => (w(t) || (t = 0), setInterval(e, t)))((() => { e.removed ? clearInterval(o) : t() }), n); return o } };
    let Qm;
    const Jm = Us.DOM,
        Zm = (e, t) => {
            const n = vl(e),
                o = Jm.getParent(t, (t => (e => Ym.isEditorUIElement(e))(t) || !!n && e.dom.is(t, n)));
            return null !== o
        },
        ef = (e, t) => {
            const n = t.editor;
            (e => {
                ...
                e.on("init", (() => {
                    e.inline && ((e, t) => {
                        const n = () => { t.throttle() };
                        Us.DOM.bind(document, "mouseup", n), e.on("remove", (() => { Us.DOM.unbind(document, "mouseup", n) }))
                    })(e, t), ((e, t) => {
                ...
                Xm.setEditorTimeout(n, (() => {
                    const t = e.focusedEditor;
                    Zm(n, (e => { try { const t = Pn(mn(e.getElement())); return zm(t).fold((() => document.body), (e => e.dom)) } catch (e) { return document.body } })(n)) || t !== n || (n.dispatch("blur", { focusedEditor: null }), e.focusedEditor = null)
                }))
            })), Qm || (Qm = t => {
                const n = e.activeEditor;
                n && Fn(t).each((t => { t.ownerDocument === document && (t === document.body || Zm(n, t) || e.focusedEditor !== n || (n.dispatch("blur", { focusedEditor: null }), e.focusedEditor = null)) }))
    ...
    class xf {
        ...
        isEmpty(e, t = {}, n) {
            ...
            if (Cf(o)) return !1;
            if (r)
                do { if (1 === r.type) { if (r.attr("data-mce-bogus")) continue; if (e[r.name]) return !1; if (Cf(r)) return !1 } if (8 === r.type) return !1; if (3 === r.type && !yf(r)) return !1; if (3 === r.type && r.parent && t[r.parent.name] && Fr(r.value)) return !1; if (n && n(r)) return !1 } while (r = vf(r, o));
            return !0
        }
        walk(e) { return vf(this, null, e) }
    }
    const wf = (e, t, n = 0) => {
    ...
    const Bf = ["font", "text-decoration", "text-emphasis"],
        ...
        Lf = (e, t, n) => {
            ...
            return V(o, (e => { const t = t => V(t, (t => t === e)); if (!t(r) && t(Bf)) { const e = K(r, (e => V(Bf, (t => ze(e, t))))); return V(e, s) } return s(e) }))
        },
        ...
        lg = e => Hd(e).exists(tr),
        dg = (e, t, n) => {
            const o = K(Zf(mn(n.container()), t), Zo),
                r = ie(o).getOr(t);
        ...
        Sg = (e, t) => M.some(t).filter(kg).bind((t => {
            const n = t.container(),
                o = ((e, t) => {
                    ...
                    const t = e.data,
                        n = (e => { const t = e.split(""); return H(t, ((e, n) => Rc(e) && n > 0 && n < t.length - 1 && Oc(t[n - 1]) && Oc(t[n + 1]) ? " " : e)).join("") })(t);
        ...
        })(t, e) ? ja(t.container(), t.offset() - 1) : t,
        ...
        Mg = (e, t, n, o = !0) => {
            const r = Bg(t, e.getBody(), n.dom),
                s = Ho(n, O(Lg, e), (a = e.getBody(), e => e.dom === a));
            var a;
            const i = ((e, t, n) => {
        ...
        $g = (e, t, n, o) => {
            ...
            if (t.isSameTable) { const t = e.bind(Hg(o)); return M.some({ start: t, end: t }) } {
                const e = zg(n.startContainer, o),
        ...
        Gg = (e, t) => {
            const n = (e => t => bn(e, t))(e),
                o = ((e, t) => {
                    const n = zg(e.startContainer, t),
                        o = zg(e.endContainer, t);
                    return Lt(n, o, Fg)
                })(t, n),
                r = ((e, t) => {
                    const n = e => yu(mn(e), t),
            ...
            return ((e, t, n) => e.exists((e => ((e, t) => !jg(e) && Vg(e, t).exists((e => { const t = e.dom.rows; return 1 === t.length && 1 === t[0].cells.length })))(e, n) && wu(e.start, t))))(o, t, n) ? o.map((e => Ug.singleCellTable(t, e.start))) : r.isMultiTable ? ((e, t, n, o) => $g(e, t, n, o).bind((({ start: e, end: o }) => {
                const r = e.bind(Wg).getOr([]),
                    s = o.bind(Wg).getOr([]);
                if (r.length > 0 && s.length > 0) { const e = Kg(n, t); return M.some(Ug.multiTable(r, s, e)) }
                return M.none()
            })))(o, r, t, n) : ((e, t, n, o) => $g(e, t, n, o).bind((({ start: e, end: t }) => e.or(t))).bind((e => { const { isSameTable: o } = t, r = Wg(e).getOr([]); if (o && e.cells.length === r.length) return M.some(Ug.fullTable(e.table)); if (r.length > 0) { if (o) return M.some(Ug.partialTable(r, M.none())); { const e = Kg(n, t); return M.some(Ug.partialTable(r, M.some({...t, rng: e }))) } } return M.none() })))(o, r, t, n)
        },
        ...
        Zg = (e, t, n) => M.some((() => {
            const o = e.selection.getRng(),
                r = n.bind((({ rng: n, isStartInTable: r }) => {
                    ...
                    n.deleteContents(), ((e, t, n) => { n.each((n => { t ? to(n) : (Xf(n), e.selection.setCursorLocation(n.dom, 0)) })) })(e, r, s.filter(qr));
        ...
        fp = (e, t, n, o = {}) => {
            const r = ((e, t, n) => { const o = { nodes: {}, attributes: {} }; return n.firstChild && cp(n.firstChild, (n => { up(e, t, n, o) })), o })(e, t, n);
            mp(r, o)
        },
        ...
        yp = e => e.collapsed ? e : (e => {
            const t = ja.fromRangeStart(e),
                n = ja.fromRangeEnd(e),
                o = e.commonAncestorContainer;
            return ic(!1, o, n).map((r => !Dd(t, n, o) && Dd(t, r, o) ? ((e, t, n, o) => { const r = document.createRange(); return r.setStart(e, t), r.setEnd(n, o), r })(t.container(), t.offset(), r.container(), r.offset()) : e)).getOr(e)
        })(e),
        Cp = (e, t) => {
            let n = t.firstChild,
                o = t.lastChild;
        ...
        Sp = (e, t, n, o) => {
            ...
            return d(1) ? ((e, t, n) => {
                ...
                const r = ((e, t) => {
                    ...
                    s = e.parentNode;
                return s.insertBefore(r[0], e), Bt.each(t, (t => { s.insertBefore(t, e) })), s.insertBefore(r[1], e), s.removeChild(e), kp(t[t.length - 1], n)
            })(s, a, l, n)
        },
        _p = Io,
        Ep = (e, t, n) => {
            ...
            return ((e, t) => {
                ...
                if (t) {
                    ...
                    Bt.each(o.select("*[data-mce-fragment]"), (e => {
                        if (C(n[e.nodeName.toLowerCase()]) && ((e, t) => te(Df(e, t), (e => !(e => Tf.has(e))(e))))(o, e))
                ...
                o.remove(t), l && o.isEmpty(l) && (eo(mn(l)), a.setStart(l, 0), a.setEnd(l, 0), _p(l) || (e => !!e.getAttribute("data-mce-fragment"))(l) || !(n = (t => { let n = ja.fromRangeStart(t); if (n = oc(e.getBody()).next(n), n) return n.toRange() })(a)) ? o.add(l, o.create("br", { "data-mce-bogus": "1" })) : (a = n, o.remove(l))), r.setRng(a)
            })(e, i.get("mce_marker")), h = e.getBody(), Bt.each(h.getElementsByTagName("*"), (e => { e.removeAttribute("data-mce-fragment") })), ((e, t) => { M.from(e.getParent(t, "td,th")).map(mn).each(Qf) })(i, a.getStart()), t
        },
        ...
        Mp = (e, t, n, o, r, s) => {
            ...
            if (a)
                if (v(a.length)) {
                    for (const i in a)
                        if (we(a, i)) {
                            const l = "attributes" === o ? e.getAttrib(t, i) : Kc(e, t, i),
                                d = $c(a[i], s),
                                c = y(l) || Ke(l);
                            if (c && y(d)) continue;
    ...
    const Zp = Bt.each,
        ...
        hh = (e, t, n, o, r) => {
            ...
            const i = o;
            if (Jc(t) && "all" === t.remove && p(t.preserve_attributes)) { const e = K(a.getAttribs(i), (e => j(t.preserve_attributes, e.name.toLowerCase()))); if (a.removeAllAttribs(i), $(e, (e => a.setAttrib(i, e.name, e.value))), e.length > 0) return ih.rename("span") }
            if ("all" !== t.remove) { dh(t.styles, ((e, o) => { e = Wc($c(e, n), o + ""), w(o) && (o = e, r = null), (t.remove_similar || !r || ch(Kc(a, r, o), e)) && a.setStyle(i, o, ""), s = !0 })), s && "" === a.getAttrib(i, "style") && (i.removeAttribute("style"), i.removeAttribute("data-mce-style")), dh(t.attributes, ((e, o) => { let s; if (e = $c(e, n), w(o) && (o = e, r = null), t.remove_similar || !r || ch(a.getAttrib(r, o), e)) { if ("class" === o && (e = a.getAttrib(i, o)) && (s = "", $(e.split(/\s+/), (e => { /mce\-\w+/.test(e) && (s += (s ? " " : "") + e) })), s)) return void a.setAttrib(i, o, s); if (lh.test(o) && i.removeAttribute("data-mce-" + o), "style" === o && Co(["li"])(i) && "none" === a.getStyle(i, "list-style-type")) return i.removeAttribute(o), void a.setStyle(i, "list-style-type", "none"); "class" === o && i.removeAttribute("className"), i.removeAttribute(o) } })), dh(t.classes, (e => { e = $c(e, n), r && !a.hasClass(r, e) || a.removeClass(i, e) })); const e = a.getAttribs(i); for (let t = 0; t < e.length; t++) { const n = e[t].nodeName; if (0 !== n.indexOf("_") && 0 !== n.indexOf("data-")) return ih.keep() } }
            return "none" !== t.remove ? (((e, t, n) => {
                const o = t.parentNode;
                let r;
                const s = e.dom,
                    a = Di(e);
                Xc(n) && o === s.getRoot() && (n.list_block && ch(t, n.list_block) || $(de(t.childNodes), (t => { Vc(e, a, t.nodeName.toLowerCase()) ? r ? r.appendChild(t) : (r = gh(s, t, a), s.setAttribs(r, Li(e))) : r = null }))), (e => Qc(e) && Jc(e) && Dt(xe(e, "mixed"), !0))(n) && !ch(n.inline, t) || s.remove(t, !0)
        ...
        yh = (e, t, n, o, r) => {
                ...
                g = t => {
                    ...
                    if (a.split) {
                        if (r = hm(r), n = mh(e, r, !0), o = mh(e, r), n !== o) {
                            if (n = fh(n, !0), o = fh(o, !1), uh(l, n, o)) { const e = M.from(n.firstChild).getOr(n); return c(ph(l, e, !0, "span", { id: "_start", "data-mce-type": "bookmark" })), void f(!0) }
                            if (uh(l, o, n)) { const e = M.from(o.lastChild).getOr(o); return c(ph(l, e, !1, "span", { id: "_end", "data-mce-type": "bookmark" })), void f(!1) }
                            n = gh(l, n, "span", { id: "_start", "data-mce-type": "bookmark" }), o = gh(l, o, "span", { id: "_end", "data-mce-type": "bookmark" });
                            const e = l.createRng();
                            e.setStartAfter(n), e.setEndBefore(o), pu(l, e, (e => { $(e, (e => { Nc(e) || Nc(e.parentNode) || c(e) })) })), c(n), c(o), n = f(!0), o = f()
                        } else n = o = c(n);
            ...
            if (o) {
                ...
                Iu(e, t, o, n)
            } else if ("false" !== l.getContentEditable(d.getNode())) d.isCollapsed() && Jc(a) && !vu(e).length ? Gp(e, t, n, r) : (Eu(d, !0, (() => { _u(e, g) })), Jc(a) && Fp(e, t, n, d.getStart()) && Uc(l, d, d.getRng()), e.nodeChanged()), Iu(e, t, o, n);
            else {
                o = d.getNode();
        ...
        kh = (e, t, n, o) => {
            const r = e.formatter.get(t),
                ...
                l = e.selection,
                d = (e, t = s) => {
                    if (x(t.onformat) && t.onformat(e, t, n, o), xh(t.styles, ((t, o) => { i.setStyle(e, o, $c(t, n)) })), t.styles) {
                ...
                f = (o, a, i) => {
                    ...
                    pu(o, a, (a => {
                        ...
                        !(l.length > 1) && o.isBlock(a) || 0 !== i ? (Jc(s) || Xc(s) && s.wrapper) && (s.exact || 1 !== i || (a = (e => { const t = Q(e.childNodes, wh).filter((e => Pp(o, e, s))); return t.map((t => { const n = o.clone(t, !1); return d(n), o.replace(n, e, !0), o.remove(t, !0), n })).getOr(e) })(a)), ((e, t, n, o) => {
                            Ch(t, (t => {
                                Jc(t) && Ch(e.dom.select(t.inline, o), (o => { eh(o) && bh(e, t, n, o, t.exact ? o : null) })), ((e, t, n) => {
                                    if (t.clear_child_styles) {
                                        const o = t.links ? "*:not(a)" : "*";
                                        Zp(e.select(o, n), (n => { eh(n) && Zp(t.styles, ((t, o) => { e.setStyle(n, o, "") })) }))
                                    }
                                })(e.dom, t, o)
                            }))
                        })(e, r, n, a), ((e, t, n, o, r) => { Ip(e, r.parentNode, n, o) && bh(e, t, o, r) || t.merge_with_parents && e.dom.getParent(r.parentNode, (s => { if (Ip(e, s, n, o)) return bh(e, t, o, r), !0 })) })(e, s, t, n, a), ((e, t, n, o) => { t.styles && t.styles.backgroundColor && rh(o, sh(e, "fontSize"), ah(e, "backgroundColor", $c(t.styles.backgroundColor, n))) })(o, s, n, a), ((e, t, n, o) => {
                            const r = t => {
                        ...
                        })(o, s, 0, a), ((e, t, n, o) => {!Jc(t) || "sub" !== t.inline && "sup" !== t.inline || (rh(o, sh(e, "fontSize"), ah(e, "fontSize", "")), e.remove(e.select("sup" === t.inline ? "sub" : "sup", o), !0)) })(o, s, 0, a), oh(o, s, 0, a)) : o.remove(a, !0)
                    }))
                };
            if ("false" !== i.getContentEditable(l.getNode())) {
                ...
                o = l.getNode();
                for (let e = 0, t = r.length; e < t; e++) { const t = r[e]; if (t.ceFalseOverride && Qc(t) && i.is(o, t.selector)) { d(o, t); break } }
                Mu(e, t, o, n)
            }
        },
        Sh = e => we(e, "vars"),
        ...
        Rh = (e, t, n) => {
            ...
            fe(n, ((n, r) => {
                const s = n => {
                    const s = Eh(e, o, r, n.similar, Sh(n) ? n.vars : void 0),
                        a = s.isSome();
                    if (n.state.get() !== a) {
                        n.state.set(a);
                        const e = s.getOr(t);
    ...
    var Ah = Object.hasOwnProperty,
        ...
        Fh = Ih.apply,
        Uh = Ih.construct;
    Fh || (Fh = function(e, t, n) { return e.apply(t, n) }), Lh || (Lh = function(e) { return e }), Ph || (Ph = function(e) { return e }), Uh || (Uh = function(e, t) { return new(Function.prototype.bind.apply(e, [null].concat(function(e) { if (Array.isArray(e)) { for (var t = 0, n = Array(e.length); t < e.length; t++) n[t] = e[t]; return n } return Array.from(e) }(t)))) });
    var zh, jh = Qh(Array.prototype.forEach),
    ...
    function eb(e, t) {
        for (; null !== e;) {
            var n = Dh(e, t);
            if (n) { if (n.get) return Qh(n.get); if ("function" == typeof n.value) return Qh(n.value) }
            e = Bh(e)
        }
    ...
    function xb(e) { if (Array.isArray(e)) { for (var t = 0, n = Array(e.length); t < e.length; t++) n[t] = e[t]; return n } return Array.from(e) }
    var wb = function() { return "undefined" == typeof window ? null : window },
        kb = function(e, t) {
        ...
        Sb = function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : wb(),
            ...
            var x = kb(g, o),
                ...
                R = o.importNode,
                A = {};
            try { A = Zh(r).documentMode ? r.documentMode : {} } catch (e) {}
            var O = {};
            ...
            var Ae = function(e) {
                ...
                Te = function(e, t) {
                    try { Hh(n.removed, { attribute: t.getAttributeNode(e), from: t }) } catch (e) { Hh(n.removed, { attribute: null, from: t }) }
                ...
                Ie = function(e) {
                    ...
                    var o = ye(e.nodeName);
                    if (Me("uponSanitizeElement", e, { tagName: o, allowedTags: F }), e.hasChildNodes() && !Pe(e.firstElementChild) && (!Pe(e.content) || !Pe(e.content.firstElementChild)) && Yh(/<[/\w]/g, e.innerHTML) && Yh(/<[/\w]/g, e.textContent)) return Oe(e), !0;
                    if ("select" === o && Yh(/<template/i, e.innerHTML)) return Oe(e), !0;
                    if (!F[o] || H[o]) {
                        if (!H[o] && Ue(o)) { if (V.tagNameCheck instanceof RegExp && Yh(V.tagNameCheck, o)) return !1; if (V.tagNameCheck instanceof Function && V.tagNameCheck(o)) return !1 }
                        if (ne && !se[o]) {
            ...
            return n.sanitize = function(e, r) {
                var a = void 0,
                    ...
                    c = void 0,
                    u = void 0;
                if ((pe = !e) && (e = "\x3c!--\x3e"), "string" != typeof e && !Pe(e)) { if ("function" != typeof e.toString) throw Xh("toString is not a function"); if ("string" != typeof(e = e.toString())) throw Xh("dirty is not a string, aborting") }
                if (!n.isSupported) { if ("object" === Cb(t.toStaticHTML) || "function" == typeof t.toStaticHTML) { if ("string" == typeof e) return t.toStaticHTML(e); if (Pe(e)) return t.toStaticHTML(e.outerHTML) } return e }
                if (X || ke(r), n.removed = [], "string" == typeof e && (oe = !1), oe) { if (e.nodeName) { var m = ye(e.nodeName); if (!F[m] || H[m]) throw Xh("root node is forbidden and cannot be sanitized in-place") } } else if (e instanceof i) 1 === (l = (a = Be("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === l.nodeName || "HTML" === l.nodeName ? a = l : a.appendChild(l);
                ...
                var o = ye(e),
                    r = ye(t);
                return Fe(o, r, n)
            }, n.addHook = function(e, t) { "function" == typeof t && (O[e] = O[e] || [], Hh(O[e], t)) }, n.removeHook = function(e) { O[e] && Vh(O[e]) }, n.removeHooks = function(e) { O[e] && (O[e] = []) }, n.removeAllHooks = function() { O = {} }, n
        }();
    const _b = (e, t, n) => {
            const o = xs();
    ...
    class Fb {
        ...
        toAbsPath(e, t) {
            ...
            let i = e.split("/");
            const l = t.split("/");
            for (Bb(i, (e => { e && s.push(e) })), i = s, n = l.length - 1, s = []; n >= 0; n--) 0 !== l[n].length && "." !== l[n] && (".." !== l[n] ? r > 0 ? r-- : s.push(l[n]) : r++);
    ...
    const Ub = Bt.makeMap,
        ...
        Kb = (e, t, n) => {
            ...
            for (let t = 0, o = s.length; t < o; t++) {
                const o = s[t],
                    a = new xf(o.nodeName.toLowerCase(), o.nodeType);
                if (yo(o)) {
        ...
        Gb = (e = {}, t = Cs()) => {
                    ...
                    parse: (e, n = {}) => {
                        ...
                        const d = r.validate,
                            ...
                            u = ((e, n, o = "html") => {
                                ...
                                return a.sanitize(u, ((e, t) => { const n = {...Hb }; return n.PARSER_MEDIA_TYPE = t, e.allow_script_urls ? n.ALLOWED_URI_REGEXP = /.*/ : e.allow_html_data_urls && (n.ALLOWED_URI_REGEXP = /^(?!(\w+script|mhtml):)/i), n })(r, i)), a.removed = [], l ? u.firstChild : u
                            })(e, c, n.format),
                            m = new xf(c, 11);
            ...
            })(l, r), ((e, t, n) => { t.inline_styles && _b(e, t, n) })(l, r, t), l
        },
        Yb = (e, t) => {
            const n = (e => Np(e) ? Of({ validate: !1 }).serialize(e) : e)(e),
                o = t(n);
            if (o.isDefaultPrevented()) return o;
            if (Np(e)) { if (o.content !== n) { const t = Gb({ validate: !1, forced_root_block: !1 }).parse(o.content, { context: e.name }); return {...o, content: t } } return {...o, content: e } }
            return o
        },
        ...
        av = (e, t) => {
            ...
            for (let e = 0; e < n.length; e++) {
                ...
                for (let n = 0; n < o.length; n++)
                    if (bn(o[n], t)) return M.some(nv(n, e))
            }
            return M.none()
        },
        iv = (e, t, n, o, r) => {
        ...
        lv = e => ((e, t) => {
            const n = da(e.element),
                o = cn("tbody");
            return Zn(o, t), Jn(n, o), n
        })(e, (e => H(e.rows, (e => {
            const t = H(e.cells, (e => { const t = ca(e); return Yt(t, "colspan"), Yt(t, "rowspan"), t })),
                n = da(e.element);
            return Zn(n, t), n
        })))(e)),
        dv = (e, t) => {
        ...
        cv = () => nm([]),
        uv = (e, t) => ((e, t) => qo(t, "table", O(bn, e)))(e, t[0]).bind((e => {
            const n = t[0],
                o = t[t.length - 1],
                r = (e => {
                    const t = ev(da(e), 0, []);
                    return $(Js(e, "tr"), ((e, n) => {
                        $(Js(e, "td,th"), ((o, r) => {
                            ((e, t, n, o, r) => {
                                const s = ov(r, "rowspan"),
                                    a = ov(r, "colspan"),
                                    i = e.rows;
                                for (let e = n; e < n + s; e++) { i[e] || (i[e] = tv(ca(o), [])); for (let o = t; o < t + a; o++) i[e].cells[o] = e === n && o === t ? r : da(r) }
                            })(t, ((e, t, n) => { for (; rv(e, t, n);) t++; return t })(t, r, n), n, e, o)
                        }))
            ...
            return ((e, t, n) => av(e, t).bind((t => av(e, n).map((n => ((e, t, n) => {
                const o = t.x,
                    ...
                    s = n.x,
                    a = n.y,
                    i = r < a ? iv(e, o, r, s, a) : iv(e, o, a, s, r);
        ...
        Ev = e => ({
            init: { bindEvents: S },
            undoManager: {
                beforeChange: (t, n) => ((e, t, n) => { kv(t) && n.set(li(e.selection)) })(e, t, n),
                ...
                undo: (t, n, o) => ((e, t, n, o) => { let r; return t.typing && (t.add(), t.typing = !1, Sv(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), r = t.data[o.get()], yv(e, r, !0), e.setDirty(!0), e.dispatch("Undo", { level: r })), r })(e, t, n, o),
                redo: (t, n) => ((e, t, n) => { let o; return t.get() < n.length - 1 && (t.set(t.get() + 1), o = n[t.get()], yv(e, o, !1), e.setDirty(!0), e.dispatch("Redo", { level: o })), o })(e, t, n),
            ...
            formatter: {
                ...
                matchAll: (t, n) => ((e, t, n) => {
                    ...
                    return e.dom.getParent(s, (s => { for (let a = 0; a < t.length; a++) { const i = t[a];!r[i] && Ip(e, s, i, n) && (r[i] = !0, o.push(i)) } }), e.dom.getRoot()), o
                })(e, t, n),
                ...
                closest: t => ((e, t) => { const n = t => bn(t, mn(e.getBody())); return M.from(e.selection.getStart(!0)).bind((o => Tp(mn(o), (n => ce(t, (t => ((t, n) => Ip(e, t.dom, n) ? M.some(n) : M.none())(n, t)))), n))).getOrNull() })(e, t),
                apply: (t, n, o) => kh(e, t, n, o),
                remove: (t, n, o, r) => yh(e, t, n, o, r),
                toggle: (t, n, o) => ((e, t, n, o) => { const r = e.formatter.get(t);!Fp(e, t, n, o) || "toggle" in r[0] && !r[0].toggle ? kh(e, t, n, o) : yh(e, t, n, o) })(e, t, n, o),
                formatChanged: (t, n, o, r, s) => ((e, t, n, o, r, s) => (null === t.get() && ((e, t) => {
                    e.set({}), t.on("NodeChange", (n => { Rh(t, n.element, e.get()) })), t.on("FormatApply FormatRemove", (n => {
                    ...
                    const a = t.get();
                    $(n.split(","), (t => {
                        const n = xe(a, t).getOrThunk((() => { const e = { withSimilar: { state: Vs(!1), similar: !0, callbacks: [] }, withoutSimilar: { state: Vs(!1), similar: !1, callbacks: [] }, withVars: [] }; return a[t] = e, e })),
                            i = () => { const n = Nh(e); return Eh(e, n, t, r, s).isSome() };
                        if (v(s)) {
                            ...
                            if ("text" === t.format) return (e => M.from(e.selection.getRng()).map((t => {
                                ...
                                const n = ((e, t) => {
                                    const n = e.selection.getRng(),
                                        ...
                                        s = uf(e, hu(r)),
                                        a = t.contextual ? mv(mn(e.getBody()), s).dom : n.cloneContents();
            ...
            autocompleter: {
                addDecoration: t => pf(e, t),
                removeDecoration: () => ((e, t) => hf(t).each((t => {
                    const n = e.selection.getBookmark();
        ...
        Pv = (e, t, n, o) => {
            ...
            const { selectorChangedWithUnbind: a } = ((e, t) => {
                ...
                return {
                    ...
                    }))), n[e] || (n[e] = []), n[e].push(a), r(e, s(t.selection.getStart())).each((() => { o[e] = n[e] })), { unbind: () => { Dv(n, e, a), Dv(o, e, a) } })
                }
            })(e, o), i = (e, t) => ((e, t, n = {}) => {
                ...
                Jb(e, o).each((t => {
                    ...
                    ((e, t) => {
                        ...
                        const r = n.bind(kn).filter(zt).bind(Tv),
                ...
                const l = (e, t, n) => { try { return t.compareBoundaryPoints(e, n) } catch (e) { return -1 } },
                    c = t.document;
                if (void 0 !== o.bookmark && !1 === rf(o)) { const e = Gm(o); if (e.isSome()) return e.map((e => uf(o, [e])[0])).getOr(c.createRange()) }
                try {
            ...
            }, u = (e, t) => { let n; if (!(e => !!e && Lv(e.startContainer) && Lv(e.endContainer))(e)) return; const a = d(); if (e = o.dispatch("SetSelectionRange", { range: e, forward: t }).range, a) { s = e; try { a.removeAllRanges(), a.addRange(e) } catch (e) {}!1 === t && a.extend && (a.collapse(e.endContainer, e.endOffset), a.extend(e.startContainer, e.startOffset)), r = a.rangeCount > 0 ? a.getRangeAt(0) : null }!e.collapsed && e.startContainer === e.endContainer && a.setBaseAndExtent && e.endOffset - e.startOffset < 2 && e.startContainer.hasChildNodes() && (n = e.startContainer.childNodes[e.startOffset], n && "IMG" === n.tagName && (a.setBaseAndExtent(e.startContainer, e.startOffset, e.endContainer, e.endOffset), a.anchorNode === e.startContainer && a.focusNode === e.endContainer || a.setBaseAndExtent(n, 0, n, 1))), o.dispatch("AfterSetSelectionRange", { range: e, forward: t }) }, m = () => {
                const t = d(),
                ...
                normalize: () => {
                    const t = c(),
                        n = d();
                    if (!(hu(n).length > 1) && Su(o)) { const n = gm(e, t); return n.each((e => { u(e, m()) })), n.getOr(t) }
                    return t
                },
                ...
                getBoundingClientRect: () => { const e = c(); return e.collapsed ? ja.fromRangeStart(e).getClientRects()[0] : e.getBoundingClientRect() },
        ...
        Iv = (e, t) => {
            ...
            return ((e, t, n) => {
                ...
                serialize: (n, a = {}) => {
                    ...
                    return "tree" === i.format ? c : ((e, t, n, o, r) => { const s = ((e, t, n) => Of(e, t).serialize(n))(t, n, o); return ((e, t, n) => { if (!t.no_events && e) { const o = ((e, t) => e.dispatch("PostProcess", t))(e, {...t, content: n }); return o.content } return n })(e, r, s) })(t, e, r, c, i)
                },
        ...
        oy = e => {
            ...
            const n = () => { const t = e.theme; return t && t.getWindowManagerImpl ? t.getWindowManagerImpl() : (() => { const e = () => { throw new Error("Theme did not provide a WindowManager implementation.") }; return { open: e, openUrl: e, alert: e, confirm: e, close: e, getParams: e, setParams: e } })() },
                ...
                s = n => { e.editorManager.setActive(e), Km(e), e.ui.show(); const o = n(); return (n => { t.push(n), (t => { e.dispatch("OpenWindow", { dialog: t }) })(n) })(o), o };
    ...
    const fy = (e, t) => {
        ...
        hy = e => {
            const t = (() => {
                ...
                const t = e => {
                        ...
                        const t = e.id || "blobid" + my++ + (() => { const e = () => Math.round(4294967295 * Math.random()).toString(36); return "s" + (new Date).getTime().toString(36) + e() + e() + e() })(),
                            n = e.name || t,
                            o = e.blob;
                        var r;
            ...
            const r = uy(),
                ...
                a = (e => {
                    ...
                    return e.on("change AddUndo", (e => { t.set({...e.level }) })), {
                        fireIfChanged: () => {
                            ...
                            le(n).filter((e => !wv(t.get(), e))).each((t => { e.setDirty(!0), e.dispatch("change", { level: t, lastLevel: ae(n, n.length - 2).getOrNull() }) }))
                        }
                    }
                })(e),
                        ...
                        const r = [],
                            s = H(n, ((n, s) => {
                                ...
                                return n.status && ji(e) ? (t.removeByUri(i.src), Nv(e) || ((t, n) => {
                                    ...
                                    var r;
                                    c(t.src, n), qt(mn(t), { src: zi(e) ? (r = n, r + (-1 === r.indexOf("?") ? "?" : "&") + (new Date).getTime()) : n, "data-mce-src": o })
                                })(i, n.url)) : n.error && (n.error.remove && (c(i.getAttribute("src"), Nt.transparentSrc), r.push(i), l = !0), ((e, t) => { sy(e, Ws.translate(["Failed to upload image: {0}", t])) })(e, n.error.message)), { element: i, status: n.status, uploadUri: n.url, blobInfo: a, removed: l }
                            }));
                        return s.length > 0 && a.fireIfChanged(), r.length > 0 && !Nv(e) && e.undoManager.transact((() => { $(r, (n => { e.dom.remove(n), t.removeByUri(n.src) })) })), s
                    })))
                })))),
                            ...
                            const s = K((e => e ? de(e.getElementsByTagName("img")) : [])(o), (t => { const n = t.src; return !t.hasAttribute("data-mce-bogus") && !t.hasAttribute("data-mce-placeholder") && !(!n || n === Nt.transparentSrc) && (0 === n.indexOf("blob:") ? !e.isUploaded(n) && r(t) : 0 === n.indexOf("data:") && r(t)) })),
                                a = H(s, (e => {
                                    ...
                                    const o = new Promise(((n, o) => {
                                        ((e, t, n, o) => {
                                            let r, s;
                                            if (0 === t.src.indexOf("blob:")) return s = e.getByUri(t.src), void(s ? n({ image: t, blobInfo: s }) : Rb(t.src).then((o => { Ab(o).then((a => { r = Eb(a).data, s = e.create(Tb(), o, r), e.add(s), n({ image: t, blobInfo: s }) })) }), (e => { o(e) })));
                                            const { data: a, type: i } = Eb(t.src);
                                            r = a, s = e.getByData(r, i), s ? n({ image: t, blobInfo: s }) : Rb(t.src).then((o => { s = e.create(Tb(), o, r), e.add(s), n({ image: t, blobInfo: s }) }), (e => { o(e) }))
                                        })(t, e, n, o)
                ...
                })(r, t)), o.findAll(e.getBody(), p).then(i((t => (t = K(t, (t => "string" != typeof t || (sy(e, t), !1))), Nv(e) || $(t, (e => { c(e.image.src, e.blobInfo.blobUri()), e.image.src = e.blobInfo.blobUri(), e.image.removeAttribute("data-mce-src") })), t))))),
            ...
            return e.on("SetContent", (() => { Ui(e) ? g() : h() })), e.on("RawSaveContent", (e => { e.content = b(e.content) })), e.on("GetContent", (e => { e.source_view || "raw" === e.format || "tree" === e.format || (e.content = b(e.content)) })), e.on("PostRender", (() => {
        ...
        _y = (e, t) => {
            ...
            })), e.dispatch("PreviewFormats"), wy.setStyles(o, { position: "absolute", left: -65535 }), e.getBody().appendChild(o), r = wy.getStyle(e.getBody(), "fontSize", !0), r = /px$/.test(r) ? parseInt(r, 10) : 0, xy(a.split(" "), (t => {
        ...
        Ey = e => {
            const t = (e => {
                    const t = {},
                        n = (e, o) => { e && (m(e) ? (p(o) || (o = [o]), $(o, (e => { v(e.deep) && (e.deep = !Qc(e)), v(e.split) && (e.split = !Qc(e) || Jc(e)), v(e.remove) && Qc(e) && !Jc(e) && (e.remove = "none"), Qc(e) && Jc(e) && (e.mixed = !0, e.block_expand = !0), m(e.classes) && (e.classes = e.classes.split(/\s+/)) })), t[e] = o) : fe(e, ((e, t) => { n(t, e) }))) };
                    return n((e => {
                        const t = e.dom,
                            n = e.schema.type,
                            o = {
                    ...
                    })(e)), n(Cy()), n(pl(e)), { get: e => C(e) ? t[e] : t, has: e => we(t, e), register: n, unregister: e => (e && t[e] && delete t[e], t) }
                })(e),
                n = Vs(null);
            return (e => {
                ...
                apply: (t, n, o) => {
                    ((e, t, n, o) => { Av(e).formatter.apply(t, n, o) })(e, t, n, o)
                },
                remove: (t, n, o, r) => {
                    ((e, t, n, o, r) => { Av(e).formatter.remove(t, n, o, r) })(e, t, n, o, r)
                },
                toggle: (t, n, o) => {
                    ((e, t, n, o) => { Av(e).formatter.toggle(t, n, o) })(e, t, n, o)
                },
        ...
        Ry = e => {
            const t = Gs(),
                ...
                r = {
                    ...
                    typing: !1,
                    beforeChange: () => {
                        ((e, t, n) => { Av(e).undoManager.beforeChange(t, n) })(e, n, t)
                    },
                    ...
                    clear: () => {
                        ((e, t, n) => { Av(e).undoManager.clear(t, n) })(e, r, o)
                    },
                    reset: () => {
                        ((e, t) => { Av(e).undoManager.reset(t) })(e, r)
                    },
                    ...
                    ignore: t => {
                        ((e, t, n) => { Av(e).undoManager.ignore(t, n) })(e, n, t)
                    },
                    extra: (t, n) => {
                        ((e, t, n, o, r) => { Av(e).undoManager.extra(t, n, o, r) })(e, r, o, t, n)
                    }
                };
            return Nv(e) || ((e, t, n) => {
                const o = Vs(!1),
                ...
                })), e.on("keydown", (e => { const s = e.keyCode; if (e.isDefaultPrevented()) return; if (s >= 33 && s <= 36 || s >= 37 && s <= 40 || 45 === s) return void(t.typing && r(e)); const a = e.ctrlKey && !e.altKey || e.metaKey;!(s < 16 || s > 20) || 224 === s || 91 === s || t.typing || a || (t.beforeChange(), Sv(t, !0, n), t.add({}, e), o.set(!0)) })), e.on("mousedown", (e => { t.typing && r(e) })), e.on("input", (e => {
                    var t;
        ...
        eC = (e, t) => {
            const n = mn(e.getBody()),
                ...
                })(e, t, n) : M.none())(n.dom, t, e.selection.getRng()).map((o => () => { Zy(n, t, o.from.block, o.to.block).each((t => { e.selection.setRng(t.toRange()) })) }));
            return o
        },
        tC = (e, t) => {
            const n = mn(t),
        ...
        nC = e => {
            ...
            return ((e, t) => {
                const n = mc(e.dom, ja.fromRangeStart(t)).isNone(),
                    o = uc(e.dom, ja.fromRangeEnd(t)).isNone();
                return !((e, t) => tC(e, t.startContainer) || tC(e, t.endContainer))(e, t) && n && o
            })(t, e.selection.getRng()) ? (e => M.some((() => { e.setContent(""), e.selection.setCursorLocation() })))(e) : ((e, t) => { const n = t.getRng(); return Lt(Vy(e, mn(n.startContainer)), Vy(e, mn(n.endContainer)), ((o, r) => !1 === bn(o, r) ? M.some((() => { n.deleteContents(), Zy(e, !0, o, r).each((e => { t.setRng(e.toRange()) })) })) : M.none())).getOr(M.none()) })(t, e.selection)
        },
        ...
        lC = (e, t, n) => t.collapsed ? ((e, t, n) => {
            const o = zd(1, e.getBody(), t),
        ...
        mC = (e, t) => ((e, t) => {
            ...
            const o = t ? Wd.Forwards : Wd.Backwards,
                r = oc(e.getBody()),
        ...
        hC = (e, t) => {
            ...
            })(e.getBody(), t, e.selection.getRng()).map((n => () => n.fold(((e, t) => n => (e._selectionOverrides.hideFakeCaret(), Mg(e, t, mn(n)), !0))(e, t), ((e, t) => n => { const o = t ? ja.before(n) : ja.after(n); return e.selection.setRng(o.toRange()), !0 })(e, t), (e => t => (e.selection.setRng(t.toRange()), !0))(e))))), (() => M.some(S)))
        },
        bC = e => {
            const t = e.dom,
                n = e.selection,
                o = dp(e.getBody(), n.getNode());
        ...
        qC = (e, t, n, o, r, s) => Lt(Py(t, n, o), Py(t, n, r), ((t, o) => t !== o && ((e, t, n) => {
            const o = Bd(t, e),
                r = Bd(n, e);
            return o && o === r
        })(n, t, o) ? TC.after(e ? t : o) : s)).getOr(s),
        ...
        GC = (e, t, n) => { const o = e ? 1 : -1; return t.setRng(ja(n.container(), n.offset() + o).toRange()), t.getSel().modify("move", e ? "forward" : "backward", "word"), !0 };
    var YC;
    ! function(e) { e[e.Br = 0] = "Br", e[e.Block = 1] = "Block", e[e.Wrap = 2] = "Wrap", e[e.Eol = 3] = "Eol" }(YC || (YC = {}));
    const XC = (e, t) => e === Wd.Backwards ? ne(t) : t,
        ...
        ZC = (e, t, n, o) => {
            ...
            for (; s;) {
                const n = QC(t, r, s);
                if (!n) break;
                if (Do(n.getNode(!1))) return t === Wd.Forwards ? { positions: XC(t, a).concat([n]), breakType: YC.Br, breakAt: M.some(n) } : { positions: XC(t, a), breakType: YC.Br, breakAt: M.some(n) };
                if (n.isVisible()) {
                    if (e(s, n)) { const e = JC(0, t, s, n); return { positions: XC(t, a), breakType: e, breakAt: M.some(n) } }
                    a.push(n), s = n
                } else s = n
            }
        ...
        cx = (e, t) => Oe(e, ((e, n) => {
            const o = Math.min(lx(e, t), dx(e, t)),
                r = Math.min(lx(n, t), dx(n, t));
        ...
        mx = e => ee(e, ux);
    var fx;
    ! function(e) { e[e.Up = -1] = "Up", e[e.Down = 1] = "Down" }(fx || (fx = {}));
    const gx = (e, t, n, o, r, s) => {
            let a = 0;
            const i = [],
                l = o => {
                    let s = mx([o]); - 1 === e && (s = s.reverse());
        ...
        xx = (e, t, n, o, r, s) => {
            const a = t === Wd.Forwards,
                i = oc(e.getBody()),
                l = O($d, a ? i.next : i.prev),
                d = a ? o : r;
            if (!n.collapsed) { const o = Ca(n); if (s(o)) return aC(t, e, o, t === Wd.Backwards, !1) }
        ...
        wx = (e, t, n, o, r, s) => {
            const a = Vd(t, e.getBody(), n),
                i = Be(a.getClientRects()),
                l = t === fx.Down;
            if (!i) return M.none();
            const d = (l ? hx : px)(e.getBody(), bx(1), a),
                c = K(d, vx(1)),
                u = i.left,
                m = cx(c, u);
            if (m && s(m.node)) {
        ...
        kx = (e, t) => {
            ...
            var s, a;
            if (t) { const e = rx(r, o); return le(e.positions) } { const e = ox(r, o); return ie(e.positions) }
        },
        ...
        Rx = (e, t, n) => !!gl(e) && ((e, t, n) => {
            const o = e.getBody(),
                r = ja.fromRangeStart(e.selection.getRng());
            return ((e, t, n, o) => {
                const r = My(e, o),
                    s = zC(t, n, r);
                return zC(t, n, r).bind(O(KC, e)).orThunk((() => ((e, t, n, o, r) => { const s = My(e, r); return ic(e, n, s).map(O(My, e)).fold((() => o.map(HC)), (r => zC(t, n, r).map(O(qC, e, t, n, s, r)).filter(O(WC, o)))).filter(UC) })(e, t, n, s, o)))
            })(n, O(Ly, e), o, r).bind((n => Nx(e, t, n)))
        })(e, t, n).isSome(),
        Ax = (e, t, n) => !!gl(t) && ((e, t) => {
            const n = t.selection.getRng(),
                o = e ? ja.fromRangeEnd(n) : ja.fromRangeStart(n);
        ...
        Ox = e => {
            ...
            return e.on("NodeChange", (o => {
                gl(e) && (((e, t, n) => {
                    const o = H(Js(mn(t.getRoot()), '*[data-mce-selected="inline-boundary"]'), (e => e.dom)),
                        r = K(o, e),
                        s = K(n, e);
        ...
        Mx = (e, t, n) => {
            if (e.selection.isCollapsed() && gl(e)) {
                ...
                return ((e, t, n, o) => {
                    const r = ((e, t) => Bd(t, e) || e)(e.getBody(), o.container()),
                        s = O(Ly, e),
                        a = zC(s, r, o);
                    return a.bind((e => n ? e.fold(N(M.some($C(e))), M.none, N(M.some(HC(e))), M.none) : e.fold(M.none, N(M.some(HC(e))), M.none, N(M.some($C(e)))))).map(Lx(e, t)).getOrThunk((() => {
                        ...
                        })).getOr(!0))(t) ? M.some((() => { Mg(e, n, mn(t)) })) : M.none())))).getOrThunk((() => l.bind((() => i.map((r => () => { n ? Px(e, t, o, r) : Px(e, t, r, o) }))))))
                    }))
                })(e, t, n, o)
            }
            return M.none()
        ...
        Fx = (e, t) => {
            const n = mn(e.getBody()),
                ...
                r = K(((e, t) => { const n = Zf(t, e); return J(n, Zo).fold(N(n), (e => n.slice(0, e))) })(n, o), Ix);
            return le(r).bind((n => {
                const o = ja.fromRangeStart(e.selection.getRng());
        ...
        jx = (e, t) => e.selection.isCollapsed() ? ((e, t) => {
            const n = t ? $f : qf,
                ...
                r = Vd(o, e.getBody(), e.selection.getRng());
            return n(r) ? zx(e, t, r.getNode(!t)) : M.from(My(t, r)).filter((e => n(e) && qd(r, e))).map((n => () => zx(e, t, n.getNode(!t))))
        })(e, t) : ((e, t) => { const n = e.selection.getNode(); return Fo(n) ? zx(e, t, n) : M.none() })(e, t),
        ...
        Qx = (e, t) => {
            e.addCommand("delete", (() => {
                ((e, t) => { Xx(e, t, !1).fold((() => { zy(e), Hy(e) }), D) })(e, t)
        ...
        nw = e => {
            ...
            for (s = a.firstChild; s;)
                if (ew(r, s)) {
                    if (tw(r, s)) { l = s, s = s.nextSibling, t.remove(l); continue }
        ...
        fw = (e, t) => {
            const n = mn(e.getBody()),
                ...
                r = Di(e),
                s = Li(e);
            return ((e, t) => { const n = O(bn, t); return $o(mn(e.container()), Zo, n).filter(mw) })(o, n).exists((() => {
        ...
        Tw = (e, t, n, o, r) => {
            const s = Js(mn(n), "td,th,caption").map((e => e.dom)),
                a = K(((e, t) => ee(t, (t => { const n = ((e, t) => ({ left: e.left - t, top: e.top - t, right: e.right + -2, bottom: e.bottom + -2, width: e.width + t, height: e.height + t }))(ga(t.getBoundingClientRect()), -1); return [{ x: n.left, y: e(n), cell: t }, { x: n.right, y: e(n), cell: t }] })))(e, s), (e => t(e, r)));
        ...
        Iw = (e, t, n, o) => {
            const r = e.selection.getRng(),
                s = t ? 1 : -1;
            return !(!bd() || !((e, t, n) => { const o = ja.fromRangeStart(t); return cc(!e, n).exists((e => e.isEqual(o))) })(t, r, n) || (aC(s, e, n, !t, !1).each((t => { yx(e, t) })), 0))
        },
        Fw = (e, t, n) => {
        ...
        Uw = (e, t, n, o) => {
            const r = e.selection.getRng(),
                ...
                a = e.getBody();
            if (!t && Pw(o, s)) { const o = ((e, t, n) => ((e, t) => ie(t.getClientRects()).bind((t => Bw(e, t.left, t.top))).bind((e => { return nx(gc(n = e).map((e => ox(n, e).positions.concat(e))).getOr([]), t); var n })))(t, n).orThunk((() => ie(n.getClientRects()).bind((n => tx(sx(e, ja.before(t)), n.left))))).getOr(ja.before(t)))(a, n, s); return Fw(e, t, o), !0 }
            if (t && Mw(o, s)) { const o = ((e, t, n) => ((e, t) => le(t.getClientRects()).bind((t => Dw(e, t.left, t.top))).bind((e => { return nx(fc(n = e).map((e => [e].concat(rx(n, e).positions))).getOr([]), t); var n })))(t, n).orThunk((() => ie(n.getClientRects()).bind((n => tx(ax(e, ja.after(t)), n.left))))).getOr(ja.after(t)))(a, n, s); return Fw(e, t, o), !0 }
            return !1
        },
        ...
        Ww = (e, t) => {
            ...
            return ((e, t) => ((e, t, n = L) => n(t) ? M.none() : j(e, Mt(t)) ? M.some(t) : qo(t, e.join(","), (e => pn(e, "table") || n(e))))(["td", "th"], e, t))(mn(t ? s.endContainer : s.startContainer), r).map((n => (Ew(n, r).each((t => { e.model.table.clearSelectedCells(t.dom) })), e.selection.collapse(!t), (t ? $w : qw)(e, r, n).each((t => { e.selection.setRng(t) })), !0))).getOr(!1)
        },
        ...
        ak = (e, t, n, o = {}) => {
            const r = t(),
                ...
                a = K(r.lookupByChar(n.triggerChar), (t => n.text.length >= t.minChars && t.matches.getOrThunk((() => (e => t => { const n = sk(t.startContainer, t.startOffset); return !((e, t) => Zw(e, t.container, t.offset, ((e, t) => 0 === t ? -1 : t), e.getRoot()).filter((e => { const t = e.container.data.charAt(e.offset - 1); return !tk(t) })).isSome())(e, n) })(e.dom)))(n.range, s, n.text)));
    ...
    var ik;
    ! function(e) { e[e.Error = 0] = "Error", e[e.Value = 1] = "Value" }(ik || (ik = {}));
    const lk = (e, t, n) => e.stype === ik.Error ? t(e.serror) : n(e.svalue),
        ...
        vk = e => {
            const t = (e => {
                const t = [],
                    n = [];
                return $(e, (e => { lk(e, (e => n.push(e)), (e => t.push(e))) })), { values: t, errors: n }
            })(e);
        ...
        kk = (e, t, n, o, r) => {
            const s = e => r.extract(t.concat([o]), e),
                a = e => e.fold((() => dk(M.none())), (e => { const n = r.extract(t.concat([o]), e); return s = n, a = M.some, s.stype === ik.Value ? { stype: ik.Value, svalue: a(s.svalue) } : s; var s, a }));
            switch (e.tag) {
                case "required":
        ...
        Sk = e => ({
            extract: (t, n) => ((e, t, n) => {
                ...
                for (const s of n) yk(s, ((n, s, a, i) => {
                    ...
                    uk(l, (e => { r.push(...e) }), (e => { o[s] = e }))
                }), ((e, n) => { o[e] = n(t) }));
                return r.length > 0 ? ck(r) : dk(o)
            })(t, n, e),
            toString: () => { const t = H(e, (e => yk(e, ((e, t, n, o) => e + " -> " + o.toString()), ((e, t) => "state(" + e + ")")))); return "obj{\n" + t.join("\n") + "}" }
        }),
    ...
    Sk([oS("contextform"), qk("initValue", N("")), Zk, ((e, t) => Lk(e, e, { tag: "required", process: {} }, _k(t)))("commands", fS), Uk("launch", Nk("type", { contextformbutton: uS, contextformtogglebutton: mS }))].concat(lS));
    const gS = e => {
            ...
            const t = Gs(),
                ...
                a = a => {
                    (n => t.get().map((t => ok(e.dom, e.selection.getRng(), t.triggerChar).bind((t => ak(e, s, t, n))))).getOrThunk((() => ((e, t) => {
                        ...
                        (n => { o() || (((e, t) => { Av(e).autocompleter.addDecoration(t) })(e, n.range), t.set({ triggerChar: n.triggerChar, matchLength: n.text.length })) })(s.context), s.lookupData.then((o => {
                            t.get().map((a => {
                                const i = s.context;
        ...
        BS = (e, t) => {
            ...
            const u = e.dom,
                ...
                h = t => {
                    ...
                    if (n = t || "TABLE" === d || "HR" === d ? u.create(t || p) : s.cloneNode(!1), a = n, !1 === Ii(e)) u.setAttrib(n, "style", null), u.setAttrib(n, "class", null);
                    else
                        do {
                            if (l[i.nodeName]) {
            ...
            gm(u, g).each((e => { g.setStart(e.startContainer, e.startOffset), g.setEnd(e.endContainer, e.endOffset) })), o = g.startContainer, r = g.startOffset;
        ...
        zS = (e, t) => {
            const n = (e => {
                const t = O(Ly, e),
                    n = ja.fromRangeStart(e.selection.getRng());
            ...
            n.isSome() ? n.each(O(US, e)) : ((e, t) => {
                const n = e.selection,
                    ...
                    r = n.getRng();
                let s, a;
                gm(o, r).each((e => { r.setStart(e.startContainer, e.startOffset), r.setEnd(e.endContainer, e.endOffset) }));
                let i = r.startOffset,
                    l = r.startContainer;
        ...
        o_ = (e, t) => {
            const n = t.container(),
                o = t.offset();
            return No(n) ? (n.insertData(o, e), M.some(ja(n, o + e.length))) : Hd(t).map((n => { const o = un(e); return t.isAtEnd() ? Xn(n, o) : Yn(n, o), ja(o.dom, e.length) }))
        },
        r_ = O(o_, dr),
        s_ = O(o_, " "),
        ...
        i_ = e => {
            const t = ja.fromRangeStart(e.selection.getRng()),
                n = mn(e.getBody());
                ...
                return (e => { e.on("keyup compositionstart", O(aw, e)) })(e), ((e, t) => {
                    ...
                    e.on("keydown", (n => {
                        !1 === n.isDefaultPrevented() && ((e, t, n) => {
                            ...
                            yw([{ keyCode: ju.BACKSPACE, action: bw(Yx, e) }, { keyCode: ju.BACKSPACE, action: bw(vC, e, !1) }, { keyCode: ju.DELETE, action: bw(vC, e, !0) }, { keyCode: ju.BACKSPACE, action: bw(mC, e, !1) }, { keyCode: ju.DELETE, action: bw(mC, e, !0) }, { keyCode: ju.BACKSPACE, action: bw(Mx, e, t, !1) }, { keyCode: ju.DELETE, action: bw(Mx, e, t, !0) }, { keyCode: ju.BACKSPACE, action: bw(lp, e, !1) }, { keyCode: ju.DELETE, action: bw(lp, e, !0) }, { keyCode: ju.BACKSPACE, action: bw(yC, e, !1) }, { keyCode: ju.DELETE, action: bw(yC, e, !0) }, { keyCode: ju.BACKSPACE, action: bw(jx, e, !1) }, { keyCode: ju.DELETE, action: bw(jx, e, !0) }, { keyCode: ju.BACKSPACE, action: bw(oC, e, !1) }, { keyCode: ju.DELETE, action: bw(oC, e, !0) }, { keyCode: ju.BACKSPACE, action: bw(eC, e, !1) }, { keyCode: ju.DELETE, action: bw(eC, e, !0) }, { keyCode: ju.BACKSPACE, action: bw(Ux, e, !1) }, { keyCode: ju.DELETE, action: bw(Ux, e, !0) }], n).each((t => { n.preventDefault(), vS(e, o).isDefaultPrevented() || (t(), bS(e, o)) }))
                        })(e, t, n)
                    })), e.on("keyup", (t => {!1 === t.isDefaultPrevented() && ((e, t) => { vw([{ keyCode: ju.BACKSPACE, action: bw(bC, e) }, { keyCode: ju.DELETE, action: bw(bC, e) }], t) })(e, t) }))
                })(e, t), (e => {
                    e.on("keydown", (t => {
                        t.keyCode === ju.ENTER && ((e, t) => {
                            var n;
                            t.isDefaultPrevented() || (t.preventDefault(), (n = e.undoManager).typing && (n.typing = !1, n.add()), e.undoManager.transact((() => {!1 === e.selection.isCollapsed() && zy(e), JS(e, t) })))
                        })(e, t)
                    }))
                })(e), (e => { e.on("keydown", (t => {!1 === t.isDefaultPrevented() && ((e, t) => { yw([{ keyCode: ju.SPACEBAR, action: bw(i_, e) }], t).each((n => { t.preventDefault(), vS(e, "insertText", { data: " " }).isDefaultPrevented() || (n(), bS(e, "insertText", { data: " " })) })) })(e, t) })) })(e), (e => {
                    e.on("input", (t => {
                        !1 === t.isComposing && (e => {
                            const t = mn(e.getBody());
                            e.selection.isCollapsed() && Sg(t, ja.fromRangeStart(e.selection.getRng())).each((t => { e.selection.setRng(t.toRange()) }))
                        })(e)
                    }))
                })(e), (e => { e.on("keydown", (t => {!1 === t.isDefaultPrevented() && ((e, t) => { vw([...l_(e)], t).each((e => { t.preventDefault() })) })(e, t) })) })(e), ((e, t) => { e.on("keydown", (n => {!1 === n.isDefaultPrevented() && ((e, t, n) => { vw([{ keyCode: ju.END, action: bw(uw, e, !0) }, { keyCode: ju.HOME, action: bw(uw, e, !1) }, { keyCode: ju.END, action: bw(ww, e, !0) }, { keyCode: ju.HOME, action: bw(ww, e, !1) }, { keyCode: ju.END, action: bw(Dx, e, !0, t) }, { keyCode: ju.HOME, action: bw(Dx, e, !1, t) }], n).each((e => { n.preventDefault() })) })(e, t, n) })) })(e, t), ((e, t) => {
                    if (ZS.os.isMacOS()) return;
                    const n = Vs(!1);
                    e.on("keydown", (t => { t_(t) && n_(n, e, !0) })), e.on("keyup", (o => {!1 === o.isDefaultPrevented() && ((e, t, n) => { vw([{ keyCode: ju.PAGE_UP, action: bw(Dx, e, !1, t) }, { keyCode: ju.PAGE_DOWN, action: bw(Dx, e, !0, t) }], n) })(e, t, o), t_(o) && n.get() && (n_(n, e, !1), e.nodeChanged()) }))
                })(e, t), t
            }
        };
    class c_ {
        constructor(e) {
            ...
            })), e.on("mouseup", (t => {!t.isDefaultPrevented() && Su(e) && ("IMG" === e.selection.getNode().nodeName ? Xm.setEditorTimeout(e, (() => { e.nodeChanged() })) : e.nodeChanged()) }))
        }
        nodeChanged(e) {
    ...
    const u_ = N("x-tinymce/html"),
        ...
        N_ = (e, t, n, o) => {
            ...
            !1 === r.cancelled && ((e, t, n) => { n || !Gl(e) ? w_(e, t) : ((e, t) => { Bt.each([S_, __, w_], (n => !0 !== n(e, t, w_))) })(e, t) })(e, r.content, o)
        },
        R_ = (e, t, n) => {
            const o = n || g_(t);
        ...
        D_ = (e, t, n) => {
            ...
            if (Vl(e) && o) {
                ...
                if (s.length > 0) return t.preventDefault(), (r = s, Promise.all(H(r, (e => Ab(e).then((t => ({ file: e, uri: t }))))))).then((t => {
                    n && e.selection.setRng(n), $(t, (t => {
                        ((e, t) => {
                            const { data: n, type: o } = Eb(t.uri), r = t.file, s = e.editorUpload.blobCache, a = s.getByData(n, o), i = null != a ? a : ((e, t, n, o) => {
                                const r = E_(),
                                    s = zi(e) && C(n.name),
        ...
        P_ = (e, t, n) => {
            ((e, t, n) => {
                ...
                e.parser.addNodeFilter("img", ((o, r, s) => {
                    if (!Vl(e) && (e => { var t; return !0 === (null === (t = e.data) || void 0 === t ? void 0 : t.paste) })(s))
                        for (const r of o) {
                            const o = r.attr("src");
        ...
        q_ = e => {
                ...
                o = (e => {
                    ...
                    return {
                        create: () => ((e, t) => {
                            ...
                            t.set(o.getRng());
                            const s = n.add(e.getBody(), "div", { id: "mcepastebin", class: "mce-pastebin", contentEditable: !0, "data-mce-bogus": "all", style: "position: fixed; top: 50%; width: 10px; height: 10px; overflow: hidden; opacity: 0" }, p_);
            ...
            (e => {
                (Nt.browser.isChromium() || Nt.browser.isSafari()) && ((e, t) => { e.on("PastePreProcess", (n => { n.content = t(e, n.content, n.internal) })) })(e, $_)
            })(e), ((e, t) => {
                e.addCommand("mceTogglePlainTextPaste", (() => {
                    ((e, t) => { "text" === t.get() ? (t.set("html"), zu(e, !1)) : (t.set("text"), zu(e, !0)), e.focus() })(e, t)
                })), e.addCommand("mceInsertClipboardContent", ((t, n) => { n.html && R_(e, n.html, n.internal), n.text && A_(e, n.text) }))
            })(e, n), (e => {
                const t = t => n => { t(e, n) },
                    n = Hl(e);
                ...
                (e => {
                    e.on("cut", (e => t => {
                        !t.isDefaultPrevented() && U_(e) && M_(t, F_(e), I_(e), (() => {
                            if (Nt.browser.isChromium() || Nt.browser.isFirefox()) {
                                const t = e.selection.getRng();
                                Xm.setEditorTimeout(e, (() => { e.selection.setRng(t), e.execCommand("Delete") }), 0)
                            } else e.execCommand("Delete")
                        }))
                    })(e)), e.on("copy", (e => t => {!t.isDefaultPrevented() && U_(e) && M_(t, F_(e), I_(e), S) })(e))
                })(e), ((e, t) => {
                    jl(e) && e.on("dragend dragover draggesture dragdrop drop drag", (e => { e.preventDefault(), e.stopPropagation() })), Vl(e) || e.on("drop", (e => {
                        ...
                        const o = z_(e, n);
                        if (y(o)) return;
                        const r = O_(n.dataTransfer),
                            s = T_(r, u_());
                        if ((!B_(r) || (e => { const t = e["text/plain"]; return !!t && 0 === t.indexOf("file://") })(r)) && D_(e, n, o)) return;
                        const a = r[u_()],
                    ...
                    })), e.on("dragstart", (e => { t.set(!0) })), e.on("dragover dragend", (n => { Vl(e) && !1 === t.get() && (n.preventDefault(), j_(e, z_(e, n))), "dragend" === n.type && t.set(!1) }))
                })(e, t), P_(e, o, n)
            }))
        },
        W_ = e => yo(e) && nr(mn(e));
    var K_;
    ! function(e) { e.Before = "before", e.After = "after" }(K_ || (K_ = {}));
    const G_ = (e, t) => Math.abs(e.left - t),
        ...
        Z_ = (e, t, n) => ((e, t, n) => {
            ...
            return ((e, t, n, o) => { const r = (t, s) => s.fold((() => J_(de(t.dom.childNodes), n, o)), (e => { const r = K(de(t.dom.childNodes), (t => t !== e.dom)); return J_(r, n, o) })).orThunk((() => { var n; return (bn(t, e) ? M.none() : (n = t, M.from(n.dom.parentElement).map(mn))).bind((e => r(e, M.some(t)))) })); return r(t, M.none()) })(o, s, t, n)
        })(e, t, n).filter((e => yd(e.node))).map((e => ((e, t) => ({ node: e.node, position: G_(e, t) < Y_(e, t) ? K_.Before : K_.After }))(e, t))),
        eE = e => {
            const t = e.getBoundingClientRect(),
                n = e.ownerDocument,
                o = n.documentElement,
        ...
        aE = e => {
            const t = Gs(),
                ...
                r = ((e, t) => n => {
                    if ((e => 0 === e.button)(n)) {
                        ...
                        if (o = t.getBody(), tE(r = s) && r !== o) {
                            ...
                            e.set({ element: s, dragging: !1, screenX: n.screenX, screenY: n.screenY, maxX: (t.inline ? r.scrollWidth : a.offsetWidth) - 2, maxY: (t.inline ? r.scrollHeight : a.offsetHeight) - 2, relX: n.pageX - o.x, relY: n.pageY - o.y, width: s.offsetWidth, height: s.offsetHeight, ghost: oE(t, s, s.offsetWidth, s.offsetHeight) })
                        }
                    }
                    var o, r
                })(t, e),
                s = ((e, t) => {
                    const n = Ys(((e, n) => { t._selectionOverrides.hideFakeCaret(), t.selection.placeCaretAt(e, n) }), 0);
                    return t.on("remove", n.cancel), o => e.on((e => {
                        ...
                        if (e.dragging) {
                            const r = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(e, ((e, t) => {
                                return n = (e => e.inline ? eE(e.getBody()) : { left: 0, top: 0 })(e), o = (e => { const t = e.getBody(); return e.inline ? { left: t.scrollLeft, top: t.scrollTop } : { left: 0, top: 0 } })(e), r = ((e, t) => {
                                    if (t.target.ownerDocument !== e.getDoc()) {
                                        const n = eE(e.getContentAreaContainer()),
                                            o = (e => {
                                                const t = e.getBody(),
                ...
                a = ((e, t) => n => {
                    e.on((e => {
                        if (e.dragging) {
                            if (((e, t, n) => t !== n && !e.dom.isChildOf(t, n) && !tE(t))(t, (e => { const t = e.getSel().getRangeAt(0).startContainer; return 3 === t.nodeType ? t.parentNode : t })(t.selection), e.element)) {
        ...
        dE = e => {
                    ...
                    if (g === f + 1 && u === o.endContainer) {
                        ...
                        if (d(o)) return (o => {
                            ...
                            const d = ((o, r) => {
                                ...
                                c = mn(o);
                            return $(Js(mn(e.getBody()), "*[data-mce-selected]"), (e => { bn(c, e) || Yt(e, i) })), n.getAttrib(o, i) || o.setAttribute(i, "1"), l = o, h(), d
                        })(o)
                    }
                    return null
                },
            ...
            return Nv(e) || (e.on("click", (t => {
                ...
                if (!1 === ((e, t, n) => {
                        const o = mn(e.getBody()),
                            ...
                            s = ((e, t, n, o) => { const r = (e => e.dom.getBoundingClientRect())(t); return { x: n - (e ? r.left + t.dom.clientLeft + Zv(t) : 0), y: o - (e ? r.top + t.dom.clientTop + Jv(t) : 0) } })(e.inline, r, t, n);
                        return ((e, t, n) => {
                            const o = Xv(e),
                                r = Qv(e);
            ...
            })), e.on("keypress", (e => { ju.modifierPressed(e) || iE(t.getNode()) && e.preventDefault() })), e.on("GetSelectionRange", (e => {
                let t = e.range;
                if (l) {
                ...
                aE(e), Ol(e) && (e => {
                    ...
                    e.on("init", (() => { Xm.setEditorTimeout(e, o, 0) }))
                })(e)
            })(e), (e => {
                const t = Ys((() => {
        ...
        bE = (e, t, n) => {
            ((e, t, n) => { if (No(e) && 0 >= e.length) return M.some(Kw(e, 0)); { const t = ma(Gw); return M.from(t.forwards(e, 0, Yw(e), n)).map((e => Kw(e.container, 0))) } })(t, 0, t).each((o => {
                const r = o.container;
        ...
        CE = (e, t, n) => {
            const o = fE(e.getRoot(), n).getOrDie("Unable to resolve path range"),
                r = o.startContainer,
                s = o.endContainer,
                a = 0 === o.endOffset ? s : s.splitText(o.endOffset),
                i = 0 === o.startOffset ? r : r.splitText(o.startOffset);
            return { prefix: t, end: a.parentNode.insertBefore(vE(e, t + "-end"), a), start: i.parentNode.insertBefore(vE(e, t + "-start"), i) }
        },
        ...
        SE = (e, t, n) => {
            ...
            return Qw(a, i - n.pattern.end.length, t).bind((l => {
                ...
                if (wE(s)) return M.some({ matches: [{ pattern: s, startRng: d, endRng: d }], position: l }); {
                    const a = _E(e, n.remainingPatterns, l.container, l.offset, t),
                    ...
                    return u.map((e => { const t = ((e, t) => uE(e, t.startContainer, t.startOffset, t.endContainer, t.endOffset))(r, e); return { matches: i.matches.concat([{ pattern: s, startRng: t, endRng: d }]), position: Kw(e.startContainer, e.startOffset) } }))
                }
            }))
        },
        _E = (e, t, n, o, r) => {
        ...
        RE = (e, t) => {
            ...
            const n = e.dom,
                ...
                r = ((e, t) => {
                    const n = ia("mce_textpattern"),
                        o = G(t, ((t, o) => { const r = CE(e, n + `_end${t.length}`, o.endRng); return t.concat([{...o, endMarker: r }]) }), []);
                    return G(o, ((t, r) => {
        ...
        AE = (e, t) => {
            ...
            const n = NE(e, t.inlinePatterns, !1),
                o = ((e, t) => {
                    const n = e.dom,
                        o = e.selection.getRng();
                    return hE(e, o).filter((t => {
                        ...
                        return r.map((t => Bt.trim(o).length === t.start.length ? [] : [{ pattern: t, range: uE(n.getRoot(), e, 0, e, 0) }]))
                    })).getOr([])
                })(e, t.blockPatterns);
            return (o.length > 0 || n.length > 0) && (e.undoManager.add(), e.undoManager.extra((() => { e.execCommand("mceInsertNewLine") }), (() => {
                e.insertContent(lr), RE(e, n), ((e, t) => {
                    ...
                    $(t, (t => ((e, t) => {
                        ...
                        return hE(e, r).each((t => { "block-format" === o.type ? ((e, t) => { const n = t.get(e); return p(n) && ie(n).exists((e => we(e, "block"))) })(o.format, e.formatter) && e.undoManager.transact((() => { bE(e.dom, t, o), e.formatter.apply(o.format) })) : "block-command" === o.type && e.undoManager.transact((() => { bE(e.dom, t, o), e.execCommand(o.cmd, !1, o.value) })) })), !0
        ...
        BE = e => {
            ...
            e.on("keydown", (t => {
                var n;
                13 !== t.keyCode || ju.modifierPressed(t) || AE(e, (n = Jl(e), { inlinePatterns: bi(n), blockPatterns: hi(n) })) && t.preventDefault()
            }), !0), e.on("keyup", (t => { TE(n, t, ((e, t) => e === t.keyCode && !1 === ju.modifierPressed(t))) && OE(e, o()) })), e.on("keypress", (n => { TE(t, n, ((e, t) => e.charCodeAt(0) === t.charCode)) && Xm.setEditorTimeout(e, (() => { OE(e, o()) })) }))
        },
        DE = e => {
            const t = Bt.each,
                n = ju.BACKSPACE,
            ...
            return Nv(e) ? (d && (p(), b(), E(), g(), c && (x(), w(), _())), l && (h(), y(), C(), k())) : (e.on("keydown", (t => {
            ...
            })(), Nt.windowsPhone || e.on("keyup focusin mouseup", (e => { ju.modifierPressed(e) || s.normalize() }), !0), d && (p(), b(), e.on("init", (() => { m("DefaultParagraphSeparator", Di(e)) })), E(), v(), a.addNodeFilter("br", (e => { let t = e.length; for (; t--;) "Apple-interchange-newline" === e[t].attr("class") && e[t].remove() })), c ? (x(), w(), _()) : g()), l && (e.on("keydown", (t => {
                if (!f(t) && t.keyCode === n) {
                ...
                e.on("keypress", (t => { let r; if (!f(t) && (8 === t.keyCode || 46 === t.keyCode) && o()) return r = n(), e.getDoc().execCommand("delete", !1, null), r(), t.preventDefault(), !1 })), r.bind(e.getDoc(), "cut", (t => { let r;!f(t) && o() && (r = n(), Xm.setEditorTimeout(e, (() => { r() }))) }))
        ...
        zE = e => {
            ...
            const a = Promise.all(((e, t, n) => { const o = [UE(e).loadAll(t)]; return e.inline ? o : o.concat([e.ui.styleSheetLoader.loadAll(n)]) })(e, o, n)).then(s).catch(s),
                i = tl(e);
            return i && ((e, t) => {
                const n = mn(e.getBody()),
                    o = Mn(Pn(n)),
        ...
        jE = e => {
            !0 !== e.removed && ((e => { Nv(e) || e.load({ initial: !0, format: "html" }), e.startContent = e.getContent({ format: "raw" }) })(e), (e => {
        ...
        VE = e => {
            ...
            })(e), e.serializer = Fv((e => { const t = e.options.get; return {...IE(e), ...FE(e), ...ME({ url_converter: t("url_converter"), url_converter_scope: t("url_converter_scope"), element_format: t("element_format"), entities: t("entities"), entity_encoding: t("entity_encoding"), indent: t("indent"), indent_after: t("indent_after"), indent_before: t("indent_before") }) } })(e), e), e.selection = Pv(e.dom, e.getWin(), e.serializer, e), e.annotator = Bu(e), e.formatter = Ey(e), e.undoManager = Ry(e), e._nodeChangeDispatcher = new c_(e), e._selectionOverrides = dE(e), (e => {
                const t = Gs(),
                    n = Vs(!1),
            ...
            const r = d_(e);
            Qx(e, r), (e => { e.on("NodeChange", O(nw, e)) })(e), (e => {
                const t = e.dom,
                    n = Di(e),
                    o = il(e),
                    r = (s, a) => {
                        if ((e => { if (Ty(e)) { const t = e.keyCode; return !By(e) && (ju.metaKeyPressed(e) || e.altKey || t >= 112 && t <= 123 || j(Ay, t)) } return !1 })(s)) return;
                        const i = e.getBody(),
                ...
                o && e.on("init", (t => { r(t, !0), e.on("change SetContent ExecCommand", r), e.on("paste", (t => Xm.setEditorTimeout(e, (() => r(t))))) }))
            })(e), q_(e);
            const s = (e => {
                const t = e;
            ...
            (e => {
                const t = e.getDoc(),
                    n = e.getBody();
                (e => { e.dispatch("PreInit") })(e), Ul(e) || (t.body.spellcheck = !1, LE.setAttrib(n, "spellcheck", "false")), e.quirks = DE(e), (e => { e.dispatch("PostRender") })(e);
                const o = ol(e);
                void 0 !== o && (n.dir = o);
                const r = zl(e);
            ...
            })(e), s.fold((() => { zE(e).then((() => jE(e))) }), (t => { e.setProgressState(!0), zE(e).then((() => { t().then((t => { e.setProgressState(!1), jE(e), Ov(e) }), (t => { e.notificationManager.open({ type: "error", text: String(t) }), jE(e), Ov(e) })) })) }))
        },
        HE = (e, t) => {
            if (e.inline || (e.getElement().style.visibility = e.orgVisibility), t || e.inline) VE(e);
            else {
        ...
        KE = e => {
            ...
            })(e) : (e => { const t = e.getElement(); return e.inline ? WE(null) : (e => { const t = qE.create("div"); return qE.insertAfter(t, e), WE(t) })(t) })(e)
        },
        GE = e => {
            e.dispatch("ScriptsLoaded"), (e => {
                const t = Bt.trim(Vi(e)),
                ...
                $(Rl(e), (n => {
                    ((e, t, n) => {
                        const o = ty.get(n),
                            r = ty.urls[n] || e.documentBaseUrl.replace(/\/$/, "");
            ...
            return e.editorContainer = n.editorContainer ? n.editorContainer : null, (e => { e.contentCSS = e.contentCSS.concat((e => dy(e, el(e)))(e), (e => dy(e, nl(e)))(e)) })(e), e.inline ? HE(e) : ((e, t) => {
                ((e, t) => {
        ...
        JE = (e, t) => {
            ...
            ((e, t) => {
                ...
                if (m(n) && !XE(n) && !we(ny.urls, n)) {
                    ...
                    ny.load(n, r).catch((() => {
                        ((e, t, n) => { ay(e, "ThemeLoadError", iy("theme", t, n)) })(e, r, n)
                    }))
                }
            })(e, t), ((e, t) => {
                const n = ml(e);
                if ("plugin" !== n && !we(Kv.urls, n)) {
                    ...
                    Kv.load(n, r).catch((() => {
                        ((e, t, n) => { ay(e, "ModelLoadError", iy("model", t, n)) })(e, r, n)
                    }))
                }
            })(e, t), ((e, t) => {
                const n = Xi(t),
                ...
                if (!1 === Ws.hasCode(n) && "en" !== n) {
                    ...
                    e.add(r).catch((() => {
                        ((e, t, n) => { ay(e, "LanguageLoadError", iy("language", t, n)) })(t, r, n)
                    }))
                }
            })(n, e), ((e, t, n) => {
                ...
                $((e => {
                    ...
                    e.add(n.url).catch((() => {
                        ((e, t, n) => { ay(e, "IconsLoadError", iy("icons", t, n)) })(t, n.url, n.name.getOrUndefined())
                    }))
                }))
            })(n, e, t), ((e, t) => {
                const n = (t, n) => {
                ...
                fe(Al(e), ((t, o) => { n(o, t), e.options.set("plugins", Rl(e).concat(o)) })), $(Rl(e), (e => {!(e = Bt.trim(e)) || ty.urls[e] || XE(e) || n(e, `plugins/${e}/plugin${t}.js`) }))
        ...
        dN = (e, t) => {
            const n = e.selection,
                o = e.dom;
            return /^ | $/.test(t) ? ((e, t, n) => { const o = mn(e.getRoot()); return n = yg(o, ja.fromRangeStart(t)) ? n.replace(/^ /, "&nbsp;") : n.replace(/^&nbsp;/, " "), Cg(o, ja.fromRangeEnd(t)) ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;") : n.replace(/&nbsp;(<br( \/)?>)?$/, " ") })(o, n.getRng(), t) : t
        },
        cN = (e, t) => {
        ...
        yN = e => {
            lN(e), (e => {
                ...
                e.editorCommands.addCommands({
                    ...
                    insertImage: (t, n, o) => { cN(e, e.dom.createHTML("img", { src: o })) },
                    insertHorizontalRule: () => { e.execCommand("mceInsertContent", !1, "<hr>") },
                    insertText: (t, n, o) => { cN(e, e.dom.encode(o)) },
                    insertHTML: (t, n, o) => { cN(e, o) },
                    mceInsertContent: (t, n, o) => { cN(e, o) },
            ...
            })(e), (e => { e.editorCommands.addCommands({ insertParagraph: () => { JS(e) }, mceInsertNewLine: (t, n, o) => { JS(e, o) }, InsertLineBreak: (t, n, o) => { zS(e, o) } }) })(e), (e => {
                (e => {
                    e.editorCommands.addCommands({
                ...
                (e => {
                    ...
                    e.editorCommands.addCommands({
                        ...
                        FontSize: (t, n, o) => {
                            ((e, t) => { e.formatter.toggle("fontsize", { value: bN(e, t) }), e.nodeChanged() })(e, o)
                        },
                        LineHeight: (t, n, o) => {
                        ...
                        ((e, t) => {
                            e.removed || (t ? sf(e) : (e => {
                                const t = e.selection,
                                    n = e.getBody();
                                let o = t.getRng();
                                e.quirks.refreshContentEditable(), void 0 !== e.bookmark && !1 === rf(e) && Gm(e).each((t => { e.selection.setRng(t), o = t }));
    ...
    class CN {
        ...
        execCommand(e, t, n, o) {
            ...
            if ("mcefocus" !== s && (/^(mceAddUndoLevel|mceEndUndoLevel)$/i.test(s) || a ? (e => { Gm(e).each((t => e.selection.setRng(t))) })(r) : r.focus()), r.dispatch("BeforeExecCommand", { command: e, ui: t, value: n }).isDefaultPrevented()) return !1;
    ...
    const xN = "data-mce-contenteditable",
    ...
    const AN = e => (e._eventDispatcher || (e._eventDispatcher = new RN({ scope: e, toggleEvent: (t, n) => { RN.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n) } })), e._eventDispatcher),
        ...
        TN = Us.DOM;
    let BN;
    const DN = (e, t) => { if ("selectionchange" === t) return e.getDoc(); if (!e.inline && /^mouse|touch|click|contextmenu|drop|dragover|dragend/.test(t)) return e.getDoc().documentElement; const n = ll(e); return n ? (e.eventRoot || (e.eventRoot = TN.select(n)[0]), e.eventRoot) : e.getBody() },
        LN = (e, t, n) => {
        ...
        PN = (e, t) => {
            ...
            const o = DN(e, t);
            if (ll(e)) {
                if (BN || (BN = {}, e.editorManager.on("removeEditor", (() => { e.editorManager.activeEditor || BN && (fe(BN, ((t, n) => { e.dom.unbind(DN(e, n)) })), BN = null) }))), BN[t]) return;
                n = n => {
                    const o = n.target,
            ...
            } else n = n => { LN(e, t, n) }, TN.bind(o, t, n), e.delegates[t] = n
        },
        MN = {...ON,
            bindPendingEventDelegates() {
                const e = this;
                Bt.each(e._pendingNativeEvents, (t => { PN(e, t) }))
            },
            toggleNativeEvent(e, t) { const n = this; "focus" !== e && "blur" !== e && (n.removed || (t ? n.initialized ? PN(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : n._pendingNativeEvents = [e] : n.initialized && (n.dom.unbind(DN(n, e), e, n.delegates[e]), delete n.delegates[e]))) },
        ...
        KN = e => {
            ...
            HN($N(e.toLowerCase(), "+"), (e => { e in WN ? n[e] = !0 : /^[0-9]{2,}$/.test(e) ? n.keyCode = parseInt(e, 10) : (n.charCode = e.charCodeAt(0), n.keyCode = qN[e] || e.toUpperCase().charCodeAt(0)) }));
            const r = [n.keyCode];
    ...
    class ZN {
        constructor(e, t, n) {
            ...
            d && (Nt.cacheSuffix = d.replace(/^[\?\&]+/, "")), this.ui = { registry: YN(), styleSheetLoader: void 0, show: S, hide: S, setEnabled: S, isEnabled: P }, this.mode = (e => {
                const t = Vs("design"),
                    n = Vs({ design: { activate: S, deactivate: S, editorReadOnly: !1 }, readonly: { activate: S, deactivate: S, editorReadOnly: !0 } });
                return (e => { e.serializer ? EN(e) : e.on("PreInit", (() => { EN(e) })) })(e), (e => { e.on("ShowCaret", (t => { _N(e) && t.preventDefault() })), e.on("ObjectSelected", (t => { _N(e) && t.preventDefault() })) })(e), {
                    isReadOnly: () => _N(e),
                    set: o => ((e, t, n, o) => {
                        if (o !== n.get()) {
                    ...
                    get: () => t.get(),
                    register: (e, t) => { n.set(((e, t, n) => { if (j(jN, t)) throw new Error(`Cannot override default mode ${t}`); return {...e, [t]: {...n, deactivate: () => { try { n.deactivate() } catch (e) { console.error(`problem while deactivating editor mode ${t}:`, e) } } } } })(n.get(), e, t)) }
                }
        ...
        addVisual(e) {
            ((e, t) => {
                ((e, t) => { Av(e).editor.addVisual(t) })(e, t)
            })(this, e)
        }
        remove() {
            (e => {
                if (!e.removed) {
                    ...
                    o && e.save({ is_removing: !0 }), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && r && $v.remove(r.nextSibling), (e => { e.dispatch("remove") })(e), e.editorManager.remove(e), !e.inline && o && (e => { $v.setStyle(e.id, "display", e.orgDisplay) })(e), (e => { e.dispatch("detach") })(e), $v.remove(e.getContainer()), qv(t), qv(n), e.destroy()
                }
            })(this)
        }
        destroy(e) {
    ...
    const sR = e => {
        ...
        dR = {...ON,
            ...
            overrideDefaults(e) {
                ...
                void 0 !== o && fe(o, ((e, t) => { Ks.PluginManager.urls[t] = e }))
            },
            init(e) {
                const t = this;
                let n;
                ...
                const s = () => {
                    ...
                    eR.unbind(window, "ready", s), (n => {
                        ...
                        })((e => { let t = e.id; return t || (t = xe(e, "name").filter((e => !eR.get(e))).getOrThunk(eR.uniqueId), e.setAttribute("id", t)), t })(s), e, s)
                    }))
                };
                return eR.bind(window, "ready", s), new Promise((e => { n ? e(n) : r = t => { e(t) } }))
            },
            get(e) { return 0 === arguments.length ? rR.slice(0) : m(e) ? Q(rR, (t => t.id === e)).getOr(null) : w(e) && rR[e] ? rR[e] : null },
            add(e) {
                const t = this,
                    n = t.get(e.id);
                return n === e || (null === n && rR.push(e), aR(!0), t.activeEditor = e, t.dispatch("AddEditor", { editor: e }), nR || (nR = e => { const n = t.dispatch("BeforeUnload"); if (n.returnValue) return e.preventDefault(), e.returnValue = n.returnValue, n.returnValue }, window.addEventListener("beforeunload", nR))), e
            },
            createEditor(e, t) { return this.add(new ZN(e, t, this)) },
            remove(e) {
                const t = this;
                let n, o;
                if (e) {
                    ...
                    tR(eR.select(e), (e => { o = t.get(e.id), o && t.remove(o) }))
                } else
                    for (n = rR.length - 1; n >= 0; n--) t.remove(rR[n])
            },
            execCommand(e, t, n) {
                var o;
                const r = this,
            ...
            triggerSave: () => { tR(rR, (e => { e.save() })) },
            addI18n: (e, t) => { Ws.add(e, t) },
            ...
            _setBaseUrl(e) { this.baseURL = new Fb(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, "")), this.baseURI = new Fb(this.baseURL) }
        };
    dR.setup();
    const cR = (() => { const e = Gs(); return { FakeClipboardItem: e => ({ items: e, types: ue(e), getType: t => xe(e, t).getOrUndefined() }), write: t => { e.set(t) }, read: () => e.get().getOrUndefined(), clear: e.clear } })(),
        uR = Math.min,
        mR = Math.max,
        fR = Math.round,
        gR = (e, t, n) => {
    ...
    const yR = {
            ...
            dom: { EventUtils: Os, TreeWalker: Xo, TextSeeker: ma, DOMUtils: Us, ScriptLoader: js, RangeUtils: bm, Serializer: Fv, StyleSheetLoader: Go, ControlSelection: Vu, BookmarkManager: Du, Selection: Pv, Event: Os.Event },
